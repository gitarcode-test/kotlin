...
public final class TranslationUtils {
  private static final Set<FqNameUnsafe> CLASSES_WITH_NON_BOXED_CHARS =
      new HashSet<>(
          Arrays.asList(
              ...
              StandardNames.FqNames.charSequence,
              StandardNames.FqNames.number));
  ...
  public static JsPropertyInitializer translateFunctionAsEcma5PropertyDescriptor(
    ...
    if (DescriptorUtils.isExtension(descriptor)
      ...
      return translateExtensionFunctionAsEcma5DataDescriptor(
          functionExpression, descriptor, context);
    } else {
  ...
  private static String getAccessorFunctionName(@NotNull FunctionDescriptor descriptor) {
    boolean isGetter =
        descriptor instanceof PropertyGetterDescriptor
            || descriptor instanceof LocalVariableAccessorDescriptor.Getter;
    return isGetter ? "get" : "set";
  }

  @NotNull
  public static JsFunction simpleReturnFunction(
      @NotNull JsScope functionScope, @NotNull JsExpression returnExpression) {
  ...
  @NotNull
  private static JsPropertyInitializer translateExtensionFunctionAsEcma5DataDescriptor(
      @NotNull JsExpression functionExpression,
      @NotNull FunctionDescriptor descriptor,
      @NotNull TranslationContext context) {
    JsObjectLiteral meta =
        createDataDescriptor(functionExpression, ModalityUtilsKt.isOverridable(descriptor), false);
    return new JsPropertyInitializer(context.getNameForDescriptor(descriptor).makeRef(), meta);
  }

  @NotNull
  public static JsExpression translateExclForBinaryEqualLikeExpr(
      @NotNull JsBinaryOperation baseBinaryExpression) {
    ...
    return new JsBinaryOperation(
        negatedOperator, baseBinaryExpression.getArg1(), baseBinaryExpression.getArg2());
  }
  ...
  public static JsBinaryOperation nullCheck(
      @NotNull JsExpression expressionToCheck, boolean isNegated) {
  ...
  public static JsBinaryOperation nullCheck(
      ...
      boolean isNegated) {
    return nullCheck(
        coerce(context, expressionToCheck, TypeUtils.makeNullable(expressionType)), isNegated);
  }
  ...
  @NotNull
  public static JsName getNameForBackingField(
      @NotNull TranslationContext context, @NotNull PropertyDescriptor descriptor) {
  ...
  public static boolean isReferenceToSyntheticBackingField(@NotNull PropertyDescriptor descriptor) {
    DeclarationDescriptor containingDescriptor = descriptor.getContainingDeclaration();
    return !JsDescriptorUtils.isSimpleFinalProperty(descriptor)
        && !(containingDescriptor instanceof PackageFragmentDescriptor);
  }

  @NotNull
  public static JsNameRef backingFieldReference(
      @NotNull TranslationContext context, @NotNull PropertyDescriptor descriptor) {
    DeclarationDescriptor containingDescriptor = descriptor.getContainingDeclaration();
    ...
    if (containingDescriptor instanceof PackageFragmentDescriptor) {
      ...
      receiver =
          context.getDispatchReceiver(
              JsDescriptorUtils.getReceiverParameterForDeclaration(containingDescriptor));
    }
  ...
  @NotNull
  public static JsExpression assignmentToBackingField(
      @NotNull TranslationContext context,
  ...
  @Nullable
  public static JsExpression translateInitializerForProperty(
      @NotNull KtProperty declaration, @NotNull TranslationContext context) {
  ...
  @NotNull
  public static JsExpression translateBaseExpression(
      @NotNull TranslationContext context, @NotNull KtUnaryExpression expression) {
  ...
  public static boolean hasCorrespondingFunctionIntrinsic(
      @NotNull TranslationContext context, @NotNull KtOperationExpression expression) {
    ...
    if (returnType != null
        && (KotlinBuiltIns.isChar(returnType)
            || KotlinBuiltIns.isLong(returnType)
            || KotlinBuiltIns.isInt(returnType))) {
      return false;
    }

    if (context.intrinsics().getFunctionIntrinsic((FunctionDescriptor) operationDescriptor, context)
        != null) return true;
  ...
  public static List<JsExpression> generateInvocationArguments(
      @NotNull JsExpression receiver, @NotNull List<? extends JsExpression> arguments) {
  ...
  @NotNull
  public static JsExpression sure(
      @NotNull KtExpression ktExpression,
      @NotNull JsExpression expression,
      @NotNull TranslationContext context) {
    return new JsInvocation(
        context.getReferenceToIntrinsic(Namer.NULL_CHECK_INTRINSIC_NAME),
        prepareForNullCheck(ktExpression, expression, context));
  }

  public static boolean isSimpleNameExpressionNotDelegatedLocalVar(
      @Nullable KtExpression expression, @NotNull TranslationContext context) {
    ...
    DeclarationDescriptor descriptor =
        context
            .bindingContext()
            .get(BindingContext.REFERENCE_TARGET, ((KtSimpleNameExpression) expression));
    return !((descriptor instanceof LocalVariableDescriptor)
            && ((LocalVariableDescriptor) descriptor).isDelegated())
        && !((descriptor instanceof PropertyDescriptor)
            && propertyAccessedByFunctionsInternally((PropertyDescriptor) descriptor, context));
  }

  private static boolean propertyAccessedByFunctionsInternally(
      @NotNull PropertyDescriptor p, @NotNull TranslationContext context) {
    return !JsDescriptorUtils.isSimpleFinalProperty(p) && context.isFromCurrentModule(p)
        || shouldAccessViaFunctions(p);
  }
  ...
  public static boolean shouldAccessViaFunctions(@NotNull CallableDescriptor descriptor) {
    if (descriptor instanceof PropertyDescriptor) {
      ...
      return shouldAccessViaFunctions(
          ((PropertyAccessorDescriptor) descriptor).getCorrespondingProperty());
    } else {
      return false;
    }
  ...
  @NotNull
  public static ValueParameterDescriptor getEnclosingContinuationParameter(
      @NotNull TranslationContext context) {
  ...
  public static ClassDescriptor getCoroutineBaseClass(@NotNull TranslationContext context) {
    FqName className =
        StandardNames.COROUTINES_PACKAGE_FQ_NAME.child(Name.identifier("CoroutineImpl"));
  ...
  @NotNull
  public static PropertyDescriptor getCoroutineProperty(
      @NotNull TranslationContext context, @NotNull String name) {
    return getCoroutineBaseClass(context)
  ...
  @NotNull
  public static FunctionDescriptor getCoroutineDoResumeFunction(
      @NotNull TranslationContext context) {
    return getCoroutineBaseClass(context)
        .getUnsubstitutedMemberScope()
  ...
  public static boolean isOverridableFunctionWithDefaultParameters(
      @NotNull FunctionDescriptor descriptor) {
  ...
  @NotNull
  public static KotlinType getReturnTypeForCoercion(
      @NotNull CallableDescriptor descriptor, boolean forcePrivate) {
    descriptor = descriptor.getOriginal();

    if (FunctionTypesKt.getFunctionTypeKind(descriptor) != null
    ...
    if (overridden.isEmpty()) {
      ...
      EffectiveVisibility effectiveVisibility =
          EffectiveVisibilityUtilsKt.effectiveVisibility(
              descriptor.getVisibility(), descriptor, true);
      boolean isPublic = effectiveVisibility.getPublicApi() && !forcePrivate;
      if (KotlinBuiltIns.isCharOrNullableChar(returnType)
    ...
    Set<KotlinType> typesFromOverriddenCallables =
        overridden.stream()
  ...
  @NotNull
  public static KotlinType getDispatchReceiverTypeForCoercion(
      @NotNull CallableDescriptor descriptor) {
    descriptor = descriptor.getOriginal();
    if (descriptor.getDispatchReceiverParameter() == null) {
      throw new IllegalArgumentException(
          "This method can only be used for class members; "
              + "given descriptor is not a member of a class "
              + descriptor);
    }
  ...
  @NotNull
  public static JsExpression coerce(
      @NotNull TranslationContext context, @NotNull JsExpression value, @NotNull KotlinType to) {
    ...
    if (signedPrimitiveFromUnsigned != null) {
      if (KotlinBuiltIns.isInt(from)) {
        ...
        if (d instanceof ClassDescriptor) {
          value =
              new JsNew(
                  ReferenceTranslator.translateAsTypeReference((ClassDescriptor) d, context),
    ...
    // SAM conversion
    if ((FunctionTypesKt.isFunctionTypeOrSubtype(from)
        || FunctionTypesKt.isSuspendFunctionTypeOrSubtype(from))) {
      ...
      if (d instanceof ClassDescriptor && ((ClassDescriptor) d).isFun()) {
        ...
        if (to.isMarkedNullable()) {
          JsConditional c =
              TranslationUtils.notNullConditional(value, new JsNullLiteral(), context);
          c.setThenExpression(
              new JsNew(
                  new JsNameRef(constructorName),
                  Collections.singletonList(c.getThenExpression())));
          value = c;
        } else {
  ...
  @NotNull
  private static JsExpression voidToUnit(
      @NotNull TranslationContext context, @NotNull JsExpression expression) {
  ...
  private static JsExpression unitToVoid(@NotNull JsExpression expression) {
    if (expression instanceof JsBinaryOperation) {
      ...
      if (binary.getOperator() == JsBinaryOperator.COMMA
          && MetadataProperties.isUnit(binary.getArg2())) {
  ...
  @NotNull
  public static JsExpression charToBoxedChar(
      @NotNull TranslationContext context, @NotNull JsExpression expression) {
  ...
  @NotNull
  private static JsExpression boxedCharToChar(
      @NotNull TranslationContext context, @NotNull JsExpression expression) {
    if (expression instanceof JsInvocation) {
      JsInvocation invocation = (JsInvocation) expression;
      BoxingKind existingKind = MetadataProperties.getBoxing(invocation);
  ...
  public static JsInvocation invokeSpecialFunction(
      @NotNull TranslationContext context,
      @NotNull SpecialFunction function,
      @NotNull JsExpression... arguments) {
