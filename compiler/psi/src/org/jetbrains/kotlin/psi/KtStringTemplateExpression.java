...
public class KtStringTemplateExpression
  ...
  public KtStringTemplateExpression(
      @NotNull KotlinPlaceHolderStub<KtStringTemplateExpression> stub) {
  ...
  private static final TokenSet STRING_ENTRIES_TYPES =
      TokenSet.create(
  ...
  public PsiLanguageInjectionHost updateText(@NotNull String text) {
    ...
    if (newExpression instanceof KtStringTemplateExpression)
      return (KtStringTemplateExpression) replace(newExpression);
  ...
  public boolean hasInterpolation() {
    for (PsiElement child : getChildren()) {
      if (child instanceof KtSimpleNameStringTemplateEntry
          || child instanceof KtBlockStringTemplateEntry) {
        return true;
      }
    }
