...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl
    implements JavaCallableMemberDescriptor {
  // TODO: It's only used to retrieve annotations from the original value parameter and can be
  // removed when
  // org.jetbrains.kotlin.descriptors.impl.FunctionDescriptorImpl.initialize accepts extension
  // parameter descriptor
  // instead of type
  public static final UserDataKey<ValueParameterDescriptor>
      ORIGINAL_VALUE_PARAMETER_FOR_EXTENSION_RECEIVER =
          new UserDataKey<ValueParameterDescriptor>() {};

  public static final UserDataKey<Boolean> HAS_ERASED_VALUE_PARAMETERS =
      new UserDataKey<Boolean>() {};
  ...
  private enum ParameterNamesStatus {
    ...
    public static ParameterNamesStatus get(boolean stable, boolean synthesized) {
      return stable
          ? (synthesized ? STABLE_SYNTHESIZED : STABLE_DECLARED)
  ...
  public SimpleFunctionDescriptorImpl initialize(
    ...
    SimpleFunctionDescriptorImpl descriptor =
        super.initialize(
  ...
  public void setParameterNamesStatus(
      boolean hasStableParameterNames, boolean hasSynthesizedParameterNames) {
    this.parameterNamesStatus =
        ParameterNamesStatus.get(hasStableParameterNames, hasSynthesizedParameterNames);
  }
  ...
  public JavaMethodDescriptor enhance(
    ...
    if (additionalUserData != null) {
      enhancedMethod.putInUserDataMap(
          additionalUserData.getFirst(), additionalUserData.getSecond());
    }
