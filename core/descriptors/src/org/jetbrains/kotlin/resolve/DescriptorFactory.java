...
public class DescriptorFactory {
  ...
  public static PropertySetterDescriptorImpl createSetter(
    ...
    ValueParameterDescriptorImpl parameter =
        PropertySetterDescriptorImpl.createSetterParameter(
            setterDescriptor, propertyDescriptor.getType(), parameterAnnotations);
  ...
  public static PropertyGetterDescriptorImpl createDefaultGetter(
      @NotNull PropertyDescriptor propertyDescriptor, @NotNull Annotations annotations) {
  ...
  public static ReceiverParameterDescriptor createExtensionReceiverParameterForCallable(
    ...
    return receiverParameterType == null
        ...
        : new ReceiverParameterDescriptorImpl(
            owner, new ExtensionReceiver(owner, receiverParameterType, null), annotations);
  }
  ...
  public static ReceiverParameterDescriptor createContextReceiverParameterForCallable(
    ...
    return receiverParameterType == null
        ...
        : new ReceiverParameterDescriptorImpl(
            owner,
            new ContextReceiver(owner, receiverParameterType, customLabelName, null),
            annotations,
  ...
  public static ReceiverParameterDescriptor createContextReceiverParameterForClass(
    ...
    return receiverParameterType == null
        ...
        : new ReceiverParameterDescriptorImpl(
            owner,
            new ContextClassReceiver(owner, receiverParameterType, customLabelName, null),
            annotations,
            NameUtils.contextReceiverName(index));
  }
}
