...
public class SemanticWhitespaceAwarePsiBuilderImpl extends PsiBuilderAdapter
  ...
  private static PsiBuilderImpl findPsiBuilderImpl(PsiBuilder builder) {
    // This is a hackish workaround for PsiBuilder interface not exposing isWhitespaceOrComment()
    // method
