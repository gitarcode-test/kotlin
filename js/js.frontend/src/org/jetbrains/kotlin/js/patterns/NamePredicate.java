...
public final class NamePredicate implements Predicate<Name> {
  ...
  public static final NamePredicate PRIMITIVE_NUMBERS =
      new NamePredicate(
          CollectionsKt.map(
              PrimitiveType.NUMBER_TYPES, (PrimitiveType type) -> type.getTypeName().asString()));

  @NotNull
  public static final NamePredicate PRIMITIVE_NUMBERS_MAPPED_TO_PRIMITIVE_JS =
      new NamePredicate(
          CollectionsKt.mapNotNull(
              PrimitiveType.NUMBER_TYPES,
              (PrimitiveType type) ->
                  type != PrimitiveType.LONG ? type.getTypeName().asString() : null));

  @NotNull public static final NamePredicate STRING = new NamePredicate("String");

  @NotNull public static final NamePredicate NUMBER = new NamePredicate("Number");

  @NotNull public static final NamePredicate BOOLEAN = new NamePredicate("Boolean");
  ...
  @NotNull private final Set<Name> validNames = new HashSet<>();
