...
public class DescriptorUtils {
  // This JVM-specific class FQ name is declared here only because it's used in MainFunctionDetector
  // which is in frontend
  ...
  public static boolean isDescriptorWithLocalVisibility(DeclarationDescriptor current) {
    return current instanceof DeclarationDescriptorWithVisibility
        && ((DeclarationDescriptorWithVisibility) current).getVisibility()
  ...
  // WARNING! Don't use this method in JVM backend, use
  // JvmCodegenUtil.isCallInsideSameModuleAsDeclared() instead.
  // The latter handles compilation against compiled part of our module correctly.
  public static boolean areInSameModule(
  ...
  public static <D extends DeclarationDescriptor> D getParentOfType(
      @Nullable DeclarationDescriptor descriptor, @NotNull Class<D> aClass) {
  ...
  public static boolean isCompanionObject(@Nullable DeclarationDescriptor descriptor) {
    return isKindOf(descriptor, ClassKind.OBJECT)
        && ((ClassDescriptor) descriptor).isCompanionObject();
  }
  ...
  private static boolean isKindOf(
      @Nullable DeclarationDescriptor descriptor, @NotNull ClassKind classKind) {
    return descriptor instanceof ClassDescriptor
        && ((ClassDescriptor) descriptor).getKind() == classKind;
  }
  ...
  public static DescriptorVisibility getDefaultConstructorVisibility(
      @NotNull ClassDescriptor classDescriptor, boolean freedomForSealedInterfacesSupported) {
   ...
   * just only one of them. TODO: probably some call-sites of this method are wrong, they should
   * handle all super-declarations
   */
  @NotNull
  @SuppressWarnings("unchecked")
  ...
  @NotNull
  @SuppressWarnings("unchecked")
  public static <D extends CallableMemberDescriptor> D unwrapSubstitutionOverride(
  ...
  @NotNull
  @SuppressWarnings("unchecked")
  public static <D extends DeclarationDescriptorWithVisibility>
      D unwrapFakeOverrideToAnyDeclaration(@NotNull D descriptor) {
  ...
  @NotNull
  public static FunctionDescriptor getFunctionByName(
      @NotNull MemberScope scope, @NotNull Name name) {
  ...
  @Nullable
  public static FunctionDescriptor getFunctionByNameOrNull(
      @NotNull MemberScope scope, @NotNull Name name) {
    for (SimpleFunctionDescriptor d :
