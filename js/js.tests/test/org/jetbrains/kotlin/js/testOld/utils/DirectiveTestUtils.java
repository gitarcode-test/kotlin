...
public class DirectiveTestUtils {
  ...
  private static final DirectiveHandler FUNCTION_CONTAINS_NO_CALLS =
      new DirectiveHandler("CHECK_CONTAINS_NO_CALLS") {
        @Override
  ...
  private static final DirectiveHandler FUNCTION_NOT_CALLED =
      new DirectiveHandler("CHECK_NOT_CALLED") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static final DirectiveHandler PROPERTY_NOT_USED =
      new DirectiveHandler("PROPERTY_NOT_USED") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          checkPropertyNotUsed(
              ast, arguments.getFirst(), arguments.findNamedArgument("scope"), false, false);
        }
      };

  private static final DirectiveHandler PROPERTY_NOT_READ_FROM =
      new DirectiveHandler("PROPERTY_NOT_READ_FROM") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          checkPropertyNotUsed(
              ast, arguments.getFirst(), arguments.findNamedArgument("scope"), false, true);
        }
      };

  private static final DirectiveHandler PROPERTY_NOT_WRITTEN_TO =
      new DirectiveHandler("PROPERTY_NOT_WRITTEN_TO") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          checkPropertyNotUsed(
              ast, arguments.getFirst(), arguments.findNamedArgument("scope"), true, false);
        }
      };

  private static final DirectiveHandler PROPERTY_WRITE_COUNT =
      new DirectiveHandler("PROPERTY_WRITE_COUNT") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          checkPropertyWriteCount(
              ast,
              arguments.getNamedArgument("name"),
              arguments.findNamedArgument("scope"),
              Integer.parseInt(arguments.getNamedArgument("count")));
        }
      };

  private static final DirectiveHandler PROPERTY_READ_COUNT =
      new DirectiveHandler("PROPERTY_READ_COUNT") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          checkPropertyReadCount(
              ast,
              arguments.getNamedArgument("name"),
              arguments.findNamedArgument("scope"),
              Integer.parseInt(arguments.getNamedArgument("count")));
  ...
  private static final DirectiveHandler EXPECT_GENERATED_JS =
  ...
  private static final DirectiveHandler CLASS_EXISTS =
      new DirectiveHandler("CHECK_CLASS_EXISTS") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments) {
  ...
  private static final DirectiveHandler FUNCTION_EXISTS =
      new DirectiveHandler("CHECK_FUNCTION_EXISTS") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static final DirectiveHandler FUNCTION_CALLED_IN_SCOPE =
      new DirectiveHandler("CHECK_CALLED_IN_SCOPE") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          ...
          checkCalledInScope(
              ...
              arguments.getNamedArgument("scope"),
              parseBooleanArgument(arguments, "qualified", true));
        }
      };

  private static final DirectiveHandler FUNCTION_NOT_CALLED_IN_SCOPE =
      new DirectiveHandler("CHECK_NOT_CALLED_IN_SCOPE") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static final DirectiveHandler FUNCTION_CALLED_TIMES =
      new DirectiveHandler("FUNCTION_CALLED_TIMES") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static boolean parseBooleanArgument(
      @NotNull ArgumentsHelper arguments, @NotNull String name, boolean defaultValue) {
    String value = arguments.findNamedArgument(name);
    return value != null ? Boolean.parseBoolean(value) : defaultValue;
  }

  private static final DirectiveHandler FUNCTIONS_HAVE_SAME_LINES =
      new DirectiveHandler("CHECK_FUNCTIONS_HAVE_SAME_LINES") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private abstract static class NodeExistenceDirective extends DirectiveHandler {
    ...
    void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments) throws Exception {
      ...
      List<T> nodes =
          collectInstances(
              klass,
              function.getBody(),
              includeNestedDeclarations != null && includeNestedDeclarations.equals("true"));
      int actualCount = 0;
  ...
  private static final DirectiveHandler COUNT_LABELS =
      new CountNodesDirective<JsLabel>("CHECK_LABELS_COUNT", JsLabel.class) {
        @Override
  ...
  private static final DirectiveHandler COUNT_VARS =
      new CountNodesDirective<>("CHECK_VARS_COUNT", JsVars.JsVar.class);

  private static final DirectiveHandler COUNT_BREAKS =
      new CountNodesDirective<>("CHECK_BREAKS_COUNT", JsBreak.class);

  private static final DirectiveHandler COUNT_NULLS =
      new CountNodesDirective<>("CHECK_NULLS_COUNT", JsNullLiteral.class);

  private static final DirectiveHandler COUNT_NEW =
      new CountNodesDirective<>("CHECK_NEW_COUNT", JsNew.class);

  private static final DirectiveHandler COUNT_CASES =
      new CountNodesDirective<>("CHECK_CASES_COUNT", JsCase.class);

  private static final DirectiveHandler COUNT_IF =
      new CountNodesDirective<>("CHECK_IF_COUNT", JsIf.class);
  ...
  private static final DirectiveHandler COUNT_BINOPS =
      new CountNodesDirective<JsBinaryOperation>("CHECK_BINOP_COUNT", JsBinaryOperation.class) {
        @Override
        protected int getActualCountFor(
            @NotNull JsBinaryOperation node, @NotNull ArgumentsHelper arguments) {
  ...
  private static final DirectiveHandler COUNT_SUPER =
      new CountNodesDirective<>("CHECK_SUPER_COUNT", JsSuperRef.class);

  private static final DirectiveHandler COUNT_DEBUGGER =
      new CountNodesDirective<>("CHECK_DEBUGGER_COUNT", JsDebugger.class);

  private static final DirectiveHandler COUNT_STRING_LITERALS =
      new CountNodesDirective<>("CHECK_STRING_LITERAL_COUNT", JsStringLiteral.class);

  private static final DirectiveHandler NOT_REFERENCED =
      new DirectiveHandler("CHECK_NOT_REFERENCED") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static final DirectiveHandler CHECK_COMMENT_EXISTS =
      new NodeExistenceDirective("CHECK_COMMENT_EXISTS", true) {
        private String text;
        private boolean isMultiLine;

        @Override
        protected String getTextForError() {
          return (isMultiLine ? "Multi line" : "Single line")
              + " comment with text '"
              + text
              + "' doesn't exist";
        }
        ...
        protected JsVisitor getJsVisitorForElement() {
          return new RecursiveJsVisitor() {
            ...
            private boolean isNeededCommentType(JsComment comment) {
              return isMultiLine
                  ? comment instanceof JsMultiLineComment
                  : comment instanceof JsSingleLineComment;
            }
          };
        }
  ...
  private static final DirectiveHandler ONLY_THIS_QUALIFIED_REFERENCES =
      new DirectiveHandler("ONLY_THIS_QUALIFIED_REFERENCES") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static final DirectiveHandler HAS_INLINE_METADATA =
      new DirectiveHandler("CHECK_HAS_INLINE_METADATA") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
  ...
  private static final DirectiveHandler HAS_NO_INLINE_METADATA =
      new DirectiveHandler("CHECK_HAS_NO_INLINE_METADATA") {
        ...
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
          ...
          JsExpression property = AstSearchUtil.getMetadataOrFunction(ast, functionName);
          String message =
              "Inline metadata has been generated for not effectively public function "
                  + functionName;
          assertTrue(message, property instanceof JsFunction);
        }
      };

  private static final DirectiveHandler HAS_NO_CAPTURED_VARS =
      new DirectiveHandler("HAS_NO_CAPTURED_VARS") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          String functionName = arguments.getNamedArgument("function");
  ...
  private static final DirectiveHandler DECLARES_VARIABLE =
      new DirectiveHandler("DECLARES_VARIABLE") {
        @Override
        void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
            throws Exception {
          String functionName = arguments.getNamedArgument("function");
          ...
          for (JsFunction function : functions) {
            ...
            if (varDeclared[0]) break;
          }

          assertTrue(
              "Function " + functionName + " does not declare variable " + varName, varDeclared[0]);
        }
      };

  private static final List<DirectiveHandler> DIRECTIVE_HANDLERS =
      Arrays.asList(
          EXPECT_GENERATED_JS,
  ...
  public static void checkFunctionContainsNoCalls(
      JsNode node, String functionName, @NotNull Set<String> exceptFunctionNames) throws Exception {
  ...
  public static void checkPropertyNotUsed(
      JsNode node, String propertyName, String scope, boolean isGetAllowed, boolean isSetAllowed)
      throws Exception {
    PropertyReferenceCollector counter =
        PropertyReferenceCollector.Companion.collect(findScope(node, scope));
    if (!isGetAllowed) {
      assertFalse(
  ...
  private static void checkPropertyReadCount(
      JsNode node, String propertyName, String scope, int expectedCount) throws Exception {
    PropertyReferenceCollector counter =
        PropertyReferenceCollector.Companion.collect(findScope(node, scope));
    assertEquals(
        "Property read count: " + propertyName + " in scope: " + scope,
        expectedCount,
        counter.unqualifiedReadCount(propertyName));
  }

  private static void checkPropertyWriteCount(
      JsNode node, String propertyName, String scope, int expectedCount) throws Exception {
    PropertyReferenceCollector counter =
        PropertyReferenceCollector.Companion.collect(findScope(node, scope));
    assertEquals(
        ...
        expectedCount,
        counter.unqualifiedWriteCount(propertyName));
  }

  public static void checkFunctionNotCalled(
      @NotNull JsNode node, @NotNull String functionName, @Nullable String exceptFunction)
      throws Exception {
    Set<String> excludedScopes =
        exceptFunction != null ? Collections.singleton(exceptFunction) : Collections.emptySet();
    ...
    assertEquals(
        "Not all excluded scopes found",
        excludedScopes.size(),
        counter.getExcludedScopeOccurrenceCount());
  }
  ...
  public static void checkCalledInScope(
    ...
    assertFalse(
        errorMessage, isCalledInScope(node, functionName, scopeFunctionName, checkQualifier));
  }
  ...
  private abstract static class DirectiveHandler {
    ...
    private static final String TARGET_BACKENDS = "TARGET_BACKENDS";

    private static final String IGNORED_BACKENDS = "IGNORED_BACKENDS";
     ...
     *
     * <p>Each entry is expected to have the following format: `// DIRECTIVE: arguments
     *
    ...
    abstract void processEntry(@NotNull JsNode ast, @NotNull ArgumentsHelper arguments)
        throws Exception;
   ...
   *
   * <p>Where: namedArg -- 'key=value' or 'key="spaced value"' positionalArg -- 'value'
   *
   * <p>Neither key, nor value should contain spaces.
   */
  private static class ArgumentsHelper {
    ...
    String getPositionalArgument(int index) {
      assert positionalArguments.size() > index
          : "Argument at index `" + index + "` not found in entry: " + entry;
      return positionalArguments.get(index);
    }

    @NotNull
    String getNamedArgument(@NotNull String name) {
      assert namedArguments.containsKey(name)
          : "Argument `" + name + "` not found in entry: " + entry;
