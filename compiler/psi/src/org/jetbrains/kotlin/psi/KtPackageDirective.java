...
public class KtPackageDirective
  ...
  public KtExpression getPackageNameExpression() {
    return KtStubbedPsiUtil.getStubOrPsiChild(
        this, KtTokenSets.INSIDE_DIRECTIVE_EXPRESSIONS, KtExpression.ARRAY_FACTORY);
  }
  ...
  public Name getNameAsName() {
    ...
    return nameIdentifier == null
        ...
        : Name.identifier(nameIdentifier.getText());
  }
