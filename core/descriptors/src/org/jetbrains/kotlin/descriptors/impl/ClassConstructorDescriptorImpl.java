...
public class ClassConstructorDescriptorImpl extends FunctionDescriptorImpl
  ...
  public static ClassConstructorDescriptorImpl createSynthesized(
      ...
      @NotNull SourceElement source) {
    return new ClassConstructorDescriptorImpl(
        containingDeclaration, null, annotations, isPrimary, Kind.SYNTHESIZED, source);
  }
  ...
  protected ClassConstructorDescriptorImpl createSubstitutedCopy(
    ...
    return new ClassConstructorDescriptorImpl(
        (ClassDescriptor) newOwner, this, annotations, isPrimary, Kind.DECLARATION, source);
  }
  ...
  public ClassConstructorDescriptor copy(
    ...
    return (ClassConstructorDescriptor)
        super.copy(newOwner, modality, visibility, kind, copyOverrides);
  }
}
