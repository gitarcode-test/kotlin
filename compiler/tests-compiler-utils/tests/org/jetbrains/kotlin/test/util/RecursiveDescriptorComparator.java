...
public class RecursiveDescriptorComparator {
  ...
  private static final DescriptorRenderer DEFAULT_RENDERER =
      DescriptorRenderer.Companion.withOptions(
          options -> {
            options.setWithDefinedIn(false);
            options.setExcludedAnnotationClasses(
                Collections.singleton(new FqName(ExpectedLoadErrorsUtil.ANNOTATION_CLASS_NAME)));
            ...
            options.setAnnotationArgumentsRenderingPolicy(
                AnnotationArgumentsRenderingPolicy.UNLESS_EMPTY);
            options.setModifiers(DescriptorRendererModifier.ALL);
            return Unit.INSTANCE;
          });

  public static final Configuration DONT_INCLUDE_METHODS_OF_OBJECT =
      new Configuration(
          false,
          false,
          false,
          ...
          errorTypesForbidden(),
          DEFAULT_RENDERER);
  public static final Configuration RECURSIVE =
      new Configuration(
          false,
          false,
          true,
  ...
  public static final Configuration RECURSIVE_ALL =
      new Configuration(
          true,
          true,
          true,
  ...
  public static final Predicate<DeclarationDescriptor> SKIP_BUILT_INS_PACKAGES =
      descriptor -> {
        if (descriptor instanceof PackageViewDescriptor) {
          return !StandardNames.BUILT_INS_PACKAGE_FQ_NAME.equals(
              ((PackageViewDescriptor) descriptor).getFqName());
        }
        return true;
      };

  private static final ImmutableSet<String> KOTLIN_ANY_METHOD_NAMES =
      ImmutableSet.of("equals", "hashCode", "toString");
  ...
  public String serializeRecursively(@NotNull DeclarationDescriptor declarationDescriptor) {
    ...
    appendDeclarationRecursively(
        ...
        DescriptorUtils.getContainingModule(declarationDescriptor),
        new Printer(result, 1),
        true);
  ...
  private void appendDeclarationRecursively(
    ...
    boolean isClassOrPackage =
        (descriptor instanceof ClassOrPackageFragmentDescriptor
    ...
    if (isClassOrPackage) {
      ...
      if (descriptor instanceof ClassDescriptor) {
        ...
        appendSubDescriptors(
            descriptor,
            module,
            klass.getDefaultType().getMemberScope(),
    ...
    if (isClassOrPackage) {
      if (!topLevel) {
        ...
        printer.printWithNoIndent(
            StringsKt.trimStart(content, Printer.LINE_SEPARATOR.toCharArray()));
      }
  ...
  private void printDescriptor(
      @NotNull DeclarationDescriptor descriptor, @NotNull Printer printer) {
    boolean isPrimaryConstructor =
        conf.checkPrimaryConstructors
            && descriptor instanceof ConstructorDescriptor
            && ((ConstructorDescriptor) descriptor).isPrimary();

    boolean isRecord =
        descriptor instanceof JavaClassDescriptor && ((JavaClassDescriptor) descriptor).isRecord();
    boolean isRecordComponent =
        descriptor instanceof JavaMethodDescriptor
            && ((JavaMethodDescriptor) descriptor).isForRecordComponent();
  ...
  private static void printEffectsIfAny(FunctionDescriptor functionDescriptor, Printer printer) {
    AbstractContractProvider contractProvider =
        functionDescriptor.getUserData(ContractProviderKey.INSTANCE);
  ...
  @NotNull
  private MemberScope getPackageScopeInModule(
      @NotNull PackageViewDescriptor descriptor, @NotNull ModuleDescriptor module) {
  ...
  private boolean isFromModule(
      @NotNull DeclarationDescriptor descriptor, @NotNull ModuleDescriptor module) {
  ...
  public static void compareDescriptors(
    ...
    if (expected == actual) {
      throw new IllegalArgumentException(
          "Don't invoke this method with expected == actual."
  ...
  private static void doCompareDescriptors(
    ...
    if (expected != null) {
      ...
      assertions.assertEquals(
          expectedSerialized, actualSerialized, () -> "Expected and actual descriptors differ");
    }
  ...
  public static class Configuration {
    ...
    public Configuration filterRecursion(@NotNull Predicate<DeclarationDescriptor> stepIntoFilter) {
      return new Configuration(
          ...
          includeMethodsOfKotlinAny,
          renderDeclarationsFromOtherModules,
          checkFunctionContracts,
          stepIntoFilter,
          validationStrategy.withStepIntoFilter(stepIntoFilter),
          renderer);
    }
    ...
    public Configuration renderDeclarationsFromOtherModules(
        boolean renderDeclarationsFromOtherModules) {
      return new Configuration(
          checkPrimaryConstructors,
          checkPropertyAccessors,
    ...
    public Configuration withValidationStrategy(
    ...
    public Configuration withRendererOptions(
        @NotNull Consumer<DescriptorRendererOptions> configure) {
      return new Configuration(
          checkPrimaryConstructors,
          checkPropertyAccessors,
          includeMethodsOfKotlinAny,
    ...
    private static DescriptorRenderer newRenderer(
        @NotNull DescriptorRenderer renderer,
        @NotNull Consumer<DescriptorRendererOptions> configure) {
