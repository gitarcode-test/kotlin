...
public class CodegenTestUtil {
  ...
  public static ClassFileFactory generateFiles(
      @NotNull KotlinCoreEnvironment environment, @NotNull CodegenTestFiles files) {
  ...
  public static void assertThrows(
    ...
    KtAssert.assertTrue(
        String.format("Exception of class %s must be thrown", exceptionClass.getName()), caught);
  }
  ...
  public static Method findDeclaredMethodByNameOrNull(
      @NotNull Class<?> aClass, @NotNull String name) {
  ...
  public static List<String> prepareJavacOptions(
    ...
    List<String> options =
        new ArrayList<>(
            Arrays.asList(
                classPathOrModulePath,
                StringsKt.join(classpath, File.pathSeparator),
                "-d",
