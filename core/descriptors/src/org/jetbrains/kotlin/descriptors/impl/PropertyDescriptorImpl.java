...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl
  ...
  @kotlin.Deprecated(
      message =
          "This method is left for binary compatibility with android.nav.safearg plugin. Used in"
              + " SafeArgSyntheticDescriptorGenerator.kt")
  public void setType(
  ...
  public void initialize(
      @Nullable PropertyGetterDescriptorImpl getter, @Nullable PropertySetterDescriptor setter) {
  ...
  public class CopyConfiguration implements PropertyDescriptor.CopyBuilder<PropertyDescriptor> {
    ...
    private ReceiverParameterDescriptor dispatchReceiverParameter =
        PropertyDescriptorImpl.this.dispatchReceiverParameter;
    ...
    @NotNull
    @Override
    public CopyBuilder<PropertyDescriptor> setTypeParameters(
  ...
  private SourceElement getSourceToUseForCopy(
      boolean preserveSource, @Nullable PropertyDescriptor original) {
  ...
  protected PropertyDescriptor doSubstitute(@NotNull CopyConfiguration copyConfiguration) {
    PropertyDescriptorImpl substitutedDescriptor =
        createSubstitutedCopy(
            ...
            getSourceToUseForCopy(
                copyConfiguration.preserveSourceElement, copyConfiguration.original));

    List<TypeParameterDescriptor> originalTypeParameters =
        copyConfiguration.newTypeParameters == null
            ? getTypeParameters()
            : copyConfiguration.newTypeParameters;
    ...
    TypeSubstitutor substitutor =
        DescriptorSubstitutor.substituteTypeParameters(
            ...
            copyConfiguration.substitution,
    ...
    if (extensionReceiverParameter != null) {
      substitutedExtensionReceiver =
          substituteParameterDescriptor(
              substitutor, substitutedDescriptor, extensionReceiverParameter);
    } else {
      substitutedExtensionReceiver = null;
    }

    List<ReceiverParameterDescriptor> substitutedContextReceivers =
    ...
    for (ReceiverParameterDescriptor contextReceiverParameter : contextReceiverParameters) {
      ReceiverParameterDescriptor substitutedContextReceiver =
          substituteContextParameterDescriptor(
              substitutor, substitutedDescriptor, contextReceiverParameter);
    ...
    PropertyGetterDescriptorImpl newGetter =
        getter == null
            ...
            : new PropertyGetterDescriptorImpl(
                ...
                copyConfiguration.modality,
                normalizeVisibility(getter.getVisibility(), copyConfiguration.kind),
                getter.isDefault(),
                getter.isExternal(),
                getter.isInline(),
                copyConfiguration.kind,
    ...
    if (newGetter != null) {
      ...
      newGetter.setInitialSignatureDescriptor(
          getSubstitutedInitialSignatureDescriptor(substitutor, getter));
      newGetter.initialize(
          returnType != null ? substitutor.substitute(returnType, Variance.OUT_VARIANCE) : null);
    }
    PropertySetterDescriptorImpl newSetter =
        setter == null
            ...
            : new PropertySetterDescriptorImpl(
                ...
                copyConfiguration.modality,
                normalizeVisibility(setter.getVisibility(), copyConfiguration.kind),
                setter.isDefault(),
                setter.isExternal(),
                setter.isInline(),
                copyConfiguration.kind,
    ...
    if (newSetter != null) {
      ...
      if (substitutedValueParameters == null) {
        ...
        substitutedValueParameters =
            Collections.<ValueParameterDescriptor>singletonList(
      ...
      newSetter.setInitialSignatureDescriptor(
          getSubstitutedInitialSignatureDescriptor(substitutor, setter));
    ...
    substitutedDescriptor.initialize(
        ...
        backingField == null
            ? null
            : new FieldDescriptorImpl(backingField.getAnnotations(), substitutedDescriptor),
        delegateField == null
            ? null
            : new FieldDescriptorImpl(delegateField.getAnnotations(), substitutedDescriptor));
    ...
    if (isConst() && compileTimeInitializerFactory != null) {
      substitutedDescriptor.setCompileTimeInitializer(
          compileTimeInitializer, compileTimeInitializerFactory);
    }
  ...
  private static ReceiverParameterDescriptor substituteParameterDescriptor(
    ...
    KotlinType substitutedType =
        substitutor.substitute(receiverParameterDescriptor.getType(), Variance.IN_VARIANCE);
    if (substitutedType == null) return null;
    return new ReceiverParameterDescriptorImpl(
        substitutedPropertyDescriptor,
        new ExtensionReceiver(
            substitutedPropertyDescriptor, substitutedType, receiverParameterDescriptor.getValue()),
  ...
  public Collection<? extends PropertyDescriptor> getOverriddenDescriptors() {
    return overriddenProperties != null
