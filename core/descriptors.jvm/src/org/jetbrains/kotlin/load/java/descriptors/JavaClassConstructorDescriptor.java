...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl
  ...
  public static JavaClassConstructorDescriptor createJavaConstructor(
    ...
    return new JavaClassConstructorDescriptor(
        containingDeclaration, null, annotations, isPrimary, Kind.DECLARATION, source);
  }
  ...
  public boolean hasSynthesizedParameterNames() {
    assert hasSynthesizedParameterNames != null
        : "hasSynthesizedParameterNames was not set: " + this;
  ...
  protected JavaClassConstructorDescriptor createDescriptor(
      ...
      @NotNull Annotations annotations) {
    return new JavaClassConstructorDescriptor(
        newOwner, original, annotations, isPrimary, kind, sourceElement);
  }
  ...
  public JavaClassConstructorDescriptor enhance(
    ...
    JavaClassConstructorDescriptor enhanced =
    ...
    // We do not use doSubstitute here as in JavaMethodDescriptor.enhance because type parameters of
