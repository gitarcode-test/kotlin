...
public abstract class JsExpression extends SourceInfoAwareJsNode {
  /**
   * Determines whether or not this expression is a leaf, such as a {@link JsNameRef}, {@link
   * JsBooleanLiteral}, and so on. Leaf expressions never need to be parenthesized.
   */
  ...
  public abstract static class JsExpressionHasArguments extends JsExpression
