...
public final class PsiUtils {
  ...
  @Nullable
  public static KtSimpleNameExpression getSelectorAsSimpleName(
  ...
  @NotNull
  public static List<KtParameter> getPrimaryConstructorParameters(
  ...
  public static CallableDescriptor getFunctionDescriptor(ResolvedCall<?> resolvedCall) {
    if (resolvedCall instanceof VariableAsFunctionResolvedCall) {
      return ((VariableAsFunctionResolvedCall) resolvedCall)
          .getVariableCall()
