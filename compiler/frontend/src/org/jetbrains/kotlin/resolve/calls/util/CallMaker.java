...
public class CallMaker {
  ...
  private static class ExpressionValueArgument implements ValueArgument {
    ...
    private ExpressionValueArgument(
        @Nullable KtExpression expression, @NotNull KtElement reportErrorsOn, boolean isExternal) {
    ...
    public boolean equals(Object o) {
      ...
      if (expression != null
          ? !expression.equals(argument.expression)
          : argument.expression != null) return false;
  ...
  @NotNull
  public static Call makeCall(
      @NotNull ReceiverValue leftAsReceiver, KtBinaryExpression expression) {
    return makeCallWithExpressions(
        expression,
        leftAsReceiver,
        null,
  ...
  public static Call makeCallForCollectionLiteral(
  ...
  @NotNull
  public static ValueArgument makeValueArgument(
      @Nullable KtExpression expression, @NotNull KtElement reportErrorsOn) {
  ...
  @NotNull
  public static ValueArgument makeExternalValueArgument(
      @NotNull KtExpression expression, @NotNull KtElement reportErrorsOn) {
    return new ExpressionValueArgument(expression, reportErrorsOn, true);
  }

  @NotNull
  public static Call makePropertyCall(
      @Nullable Receiver explicitReceiver,
      @Nullable ASTNode callOperationNode,
  ...
  @NotNull
  public static Call makeConstructorCallForEnumEntryWithoutInitializer(
      @NotNull KtSuperTypeCallEntry callElement) {
    return new Call() {
      @Nullable
      @Override
      public ASTNode getCallOperationNode() {
  ...
  public static Call makeCall(
      @Nullable Receiver explicitReceiver,
      @Nullable ASTNode callOperationNode,
      @NotNull KtCallElement callElement) {
    return new Call() {
      @Override
      public ASTNode getCallOperationNode() {
        return callOperationNode;
  ...
  @NotNull
  public static Call makeCall(
      @NotNull KtElement callElement, @NotNull ReceiverValue explicitReceiver) {
