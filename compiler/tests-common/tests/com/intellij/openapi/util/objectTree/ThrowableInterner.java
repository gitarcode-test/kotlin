 ...
 *
 * <p>If you insist, JVM stores stacktrace information in compact form in Throwable.backtrace field,
 * but blocks reflective access to this field. This class uses this field for comparing Throwables.
...
public final class ThrowableInterner {
  ...
  private static final Interner<Throwable> myTraceInterner =
      new WeakInterner<>(
          new HashingStrategy<Throwable>() {
            @Override
  ...
  // more accurate hash code (different for different line numbers inside same method) but more
  // expensive than computeTraceHashCode
  public static int computeAccurateTraceHashCode(@NotNull Throwable throwable) {
    Object[] backtrace = getBacktrace(throwable);
    if (backtrace == null) {
      StackTraceElement[] trace =
          throwable instanceof UntraceableException ? null : throwable.getStackTrace();
