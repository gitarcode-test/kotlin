...
public class CompilerConfiguration {
  ...
  public <K, V> void put(
      @NotNull CompilerConfigurationKey<Map<K, V>> configurationKey,
      @NotNull K key,
      @NotNull V value) {
    checkReadOnly();
  ...
  public <T> void addAll(
      @NotNull CompilerConfigurationKey<List<T>> key, @Nullable Collection<T> values) {
    if (values != null) {
  ...
  public <T> void addAll(
      @NotNull CompilerConfigurationKey<List<T>> key, int index, @NotNull Collection<T> values) {
    checkReadOnly();
