...
public class OperatorConventions {
  ...
  public static final ImmutableSet<Name> NUMBER_CONVERSIONS =
      ImmutableSet.of(DOUBLE, FLOAT, LONG, INT, SHORT, BYTE, CHAR);
  ...
  public static final ImmutableBiMap<KtSingleValueToken, Name> UNARY_OPERATION_NAMES =
      ImmutableBiMap.<KtSingleValueToken, Name>builder()
  ...
  public static final ImmutableBiMap<Name, Name> REM_TO_MOD_OPERATION_NAMES =
      ImmutableBiMap.<Name, Name>builder().put(REM, MOD).put(REM_ASSIGN, MOD_ASSIGN).build();

  public static final ImmutableSet<KtSingleValueToken> NOT_OVERLOADABLE =
      ImmutableSet.of(
          KtTokens.ANDAND, KtTokens.OROR, KtTokens.ELVIS, KtTokens.EQEQEQ, KtTokens.EXCLEQEQEQ);
  ...
  public static final ImmutableBiMap<KtSingleValueToken, KtSingleValueToken>
      ASSIGNMENT_OPERATION_COUNTERPARTS =
          ImmutableBiMap.<KtSingleValueToken, KtSingleValueToken>builder()
  ...
  public static final ImmutableBiMap<KtSingleValueToken, Name> BOOLEAN_OPERATIONS =
      ImmutableBiMap.<KtSingleValueToken, Name>builder()
  ...
  @Nullable
  public static Name getNameForOperationSymbol(
      @NotNull KtToken token, boolean unaryOperations, boolean binaryOperations) {
    Name name;
