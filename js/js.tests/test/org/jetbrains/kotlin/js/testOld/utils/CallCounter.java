...
public class CallCounter extends RecursiveJsVisitor {
  ...
  @NotNull private final Set<String> exceptFunctionNames;

  @NotNull private final Set<String> exceptScopes;
  ...
  public static CallCounter countCalls(
      @NotNull JsNode node, @NotNull Set<String> exceptFunctionNames) {
    CallCounter visitor =
        new CallCounter(new HashSet<>(exceptFunctionNames), Collections.emptySet());
    node.accept(visitor);
  ...
  @NotNull
  public static CallCounter countCallsWithExcludedScopes(
      @NotNull JsNode node, @NotNull Set<String> exceptScopes) {
