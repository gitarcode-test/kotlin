...
public class AsmUtil {
  ...
  private static final Map<Visibility, Integer> visibilityToAccessFlag =
      ImmutableMap.<Visibility, Integer>builder()
  ...
  */
  ...
  // For non-inlined callable references ('kotlin.jvm.internal.CallableReference' has a 'receiver'
  // field)
  ...
  static {
    ...
    for (JvmPrimitiveType primitiveType : JvmPrimitiveType.values()) {
      ...
      typeByWrapperBuilder.put(
          asmTypeByFqNameWithoutInnerClasses(primitiveType.getWrapperFqName()), asmType);
    }
  ...
  @NotNull
  public static String getLabeledThisName(
      @NotNull String callableName, @NotNull String prefix, @NotNull String defaultName) {
  ...
  public static Type boxPrimitiveType(@NotNull Type type) {
    ...
    return jvmPrimitiveType != null
        ? asmTypeByFqNameWithoutInnerClasses(jvmPrimitiveType.getWrapperFqName())
        : null;
  }
  ...
  public static Method method(
      @NotNull String name, @NotNull Type returnType, @NotNull Type... parameterTypes) {
  ...
  public static void genThrow(
      @NotNull InstructionAdapter v, @NotNull String exception, @Nullable String message) {
  ...
  public static Type comparisonOperandType(Type left, Type right) {
    if (!isPrimitive(left) || !isPrimitive(right)) {
      throw new IllegalArgumentException(
          "Cannot compute comparison operand type: " + left + ", " + right);
    }
    if (left == Type.BOOLEAN_TYPE || right == Type.BOOLEAN_TYPE) {
      if (left != Type.BOOLEAN_TYPE || right != Type.BOOLEAN_TYPE) {
        throw new IllegalArgumentException(
            "Cannot compare boolean with non-boolean: " + left + ", " + right);
      }
  ...
  public static Type numberFunctionOperandType(@NotNull Type expectedType) {
    if (expectedType == Type.SHORT_TYPE
        || expectedType == Type.BYTE_TYPE
        || expectedType == Type.CHAR_TYPE) {
      return Type.INT_TYPE;
    }
    return expectedType;
  }
  ...
  public static void pop2(
      @NotNull MethodVisitor v, @NotNull Type topOfStack, @NotNull Type afterTop) {
  ...
  public static void dupSecond(
      @NotNull InstructionAdapter v, @NotNull Type topOfStack, @NotNull Type afterTop) {
  ...
  public static void dup(
    ...
    if (topOfStack.getSize() == 0) {
      ...
      throw new UnsupportedOperationException(
          "Don't know how generate dup3/dup4 for: " + topOfStack + " and " + afterTop);
    }
  }
  ...
  public static void writeAnnotationData(
    ...
    AnnotationVisitor stringsVisitor =
        av.visitArray(JvmAnnotationNames.METADATA_STRINGS_FIELD_NAME);
  ...
  public static void wrapJavaClassIntoKClass(@NotNull InstructionAdapter v) {
    v.invokestatic(
        ...
        Type.getMethodDescriptor(K_CLASS_TYPE, getType(Class.class)),
        false);
  }
  ...
  public static void wrapJavaClassesIntoKClasses(@NotNull InstructionAdapter v) {
    v.invokestatic(
        ...
        Type.getMethodDescriptor(K_CLASS_ARRAY_TYPE, getType(Class[].class)),
        false);
  }
