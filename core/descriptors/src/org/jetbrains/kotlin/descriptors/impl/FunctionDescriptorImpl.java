...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl
  ...
  // 2. isHiddenForResolutionEverywhereBesideSupercalls propagates to it's overrides descriptors
  // while isHiddenToOvercomeSignatureClash does not
  ...
  @Nullable private FunctionDescriptor initialSignatureDescriptor = null;
      ...
      if (typeParameterDescriptor.getIndex() != i) {
        throw new IllegalStateException(
            typeParameterDescriptor
                + " index is "
                + typeParameterDescriptor.getIndex()
                + " but position is "
                + i);
      }
    }
  ...
  private void setHiddenForResolutionEverywhereBesideSupercalls(
  ...
  public void setExtensionReceiverParameter(
      @NotNull ReceiverParameterDescriptor extensionReceiverParameter) {
    this.extensionReceiverParameter = extensionReceiverParameter;
  }
  ...
  public Collection<? extends FunctionDescriptor> getOverriddenDescriptors() {
    ...
    return overriddenFunctions != null
        ? overriddenFunctions
  ...
  public class CopyConfiguration
      implements SimpleFunctionDescriptor.CopyBuilder<FunctionDescriptor> {
    ...
    protected @NotNull DescriptorVisibility newVisibility;
    ...
    protected @Nullable ReceiverParameterDescriptor dispatchReceiverParameter =
        FunctionDescriptorImpl.this.dispatchReceiverParameter;
    ...
    @Override
    @NotNull
    public CopyConfiguration setValueParameters(
    ...
    @NotNull
    @Override
    public CopyBuilder<FunctionDescriptor> setContextReceiverParameters(
        @NotNull List<ReceiverParameterDescriptor> contextReceiverParameters) {
    ...
    @NotNull
    @Override
    public CopyConfiguration setExtensionReceiverParameter(
        @Nullable ReceiverParameterDescriptor extensionReceiverParameter) {
    ...
    @Override
    @NotNull
    public CopyConfiguration setDispatchReceiverParameter(
        @Nullable ReceiverParameterDescriptor dispatchReceiverParameter) {
      this.dispatchReceiverParameter = dispatchReceiverParameter;
      return this;
    }
    ...
    @NotNull
    @Override
    public <V> CopyBuilder<FunctionDescriptor> putUserData(
        @NotNull UserDataKey<V> userDataKey, V value) {
  ...
  protected FunctionDescriptor doSubstitute(@NotNull CopyConfiguration configuration) {
    ...
    Annotations resultAnnotations =
        configuration.additionalAnnotations != null
            ? AnnotationsKt.composeAnnotations(
                getAnnotations(), configuration.additionalAnnotations)
            : getAnnotations();
    ...
    List<TypeParameterDescriptor> unsubstitutedTypeParameters =
        configuration.newTypeParameters == null
            ? getTypeParameters()
            : configuration.newTypeParameters;
    ...
    List<ReceiverParameterDescriptor> substitutedContextReceiverParameters =
        new ArrayList<ReceiverParameterDescriptor>();
    if (!configuration.newContextReceiverParameters.isEmpty()) {
      int index = 0;
      for (ReceiverParameterDescriptor newContextReceiverParameter :
          configuration.newContextReceiverParameters) {
        ...
        ReceiverParameterDescriptor substitutedContextReceiverParameter =
            DescriptorFactory.createContextReceiverParameterForCallable(
                substitutedDescriptor,
                substitutedContextReceiverType,
                ((ImplicitContextReceiver) newContextReceiverParameter.getValue())
                    .getCustomLabelName(),
    ...
    if (configuration.newExtensionReceiverParameter != null) {
      KotlinType substitutedExtensionReceiverType =
          substitutor.substitute(
              configuration.newExtensionReceiverParameter.getType(), Variance.IN_VARIANCE);
      ...
      substitutedReceiverParameter =
          new ReceiverParameterDescriptorImpl(
              ...
              new ExtensionReceiver(
                  substitutedDescriptor,
                  substitutedExtensionReceiverType,
                  configuration.newExtensionReceiverParameter.getValue()),
              configuration.newExtensionReceiverParameter.getAnnotations());

      wereChanges[0] |=
          substitutedExtensionReceiverType != configuration.newExtensionReceiverParameter.getType();
    }

    ReceiverParameterDescriptor substitutedExpectedThis = null;
    if (configuration.dispatchReceiverParameter != null) {
      // When generating fake-overridden member it's dispatch receiver parameter has type of Base,
      // and it's correct.
      // E.g.
      // class Base { fun foo() }
      // class Derived : Base
      ...
      //    // but it would if fake-overridden `foo` had `Derived` as it's dispatch receiver
      // parameter type
      //    x.foo()
      // }
    ...
    KotlinType substitutedReturnType =
        substitutor.substitute(configuration.newReturnType, Variance.OUT_VARIANCE);
    ...
    substitutedDescriptor.initialize(
        ...
        substitutedContextReceiverParameters,
        substitutedTypeParameters,
    ...
    substitutedDescriptor.setHiddenToOvercomeSignatureClash(
        configuration.isHiddenToOvercomeSignatureClash);
    substitutedDescriptor.setHiddenForResolutionEverywhereBesideSupercalls(
        configuration.isHiddenForResolutionEverywhereBesideSupercalls);

    substitutedDescriptor.setHasSynthesizedParameterNames(
        configuration.newHasSynthesizedParameterNames != null
            ? configuration.newHasSynthesizedParameterNames
    ...
    if (configuration.signatureChange || getInitialSignatureDescriptor() != null) {
      FunctionDescriptor initialSignature =
          (getInitialSignatureDescriptor() != null ? getInitialSignatureDescriptor() : this);
    ...
    if (configuration.copyOverrides && !getOriginal().getOverriddenDescriptors().isEmpty()) {
      if (configuration.substitution.isEmpty()) {
        Function0<Collection<FunctionDescriptor>> overriddenFunctionsTask =
            lazyOverriddenFunctionsTask;
        ...
        substitutedDescriptor.lazyOverriddenFunctionsTask =
            new Function0<Collection<FunctionDescriptor>>() {
              @Override
  ...
  private SourceElement getSourceToUseForCopy(
      boolean preserveSource, @Nullable FunctionDescriptor original) {
  ...
  public static List<ValueParameterDescriptor> getSubstitutedValueParameters(
    ...
    List<ValueParameterDescriptor> result =
        new ArrayList<ValueParameterDescriptor>(unsubstitutedValueParameters.size());
    for (ValueParameterDescriptor unsubstitutedValueParameter : unsubstitutedValueParameters) {
      ...
      if (substitutedType != unsubstitutedValueParameter.getType()
          || varargElementType != substituteVarargElementType) {
        if (wereChanges != null) {
          wereChanges[0] = true;
        }
      }
      ...
      if (unsubstitutedValueParameter
          instanceof ValueParameterDescriptorImpl.WithDestructuringDeclaration) {
        ...
        destructuringVariablesAction =
            new Function0<List<VariableDescriptor>>() {
              @Override
      ...
      result.add(
          ValueParameterDescriptorImpl.createWithDestructuringDeclarations(
              ...
              preserveSourceElement
                  ? unsubstitutedValueParameter.getSource()
                  : SourceElement.NO_SOURCE,
              destructuringVariablesAction));
    }
    return result;
  ...
  private void setInitialSignatureDescriptor(
      @Nullable FunctionDescriptor initialSignatureDescriptor) {
