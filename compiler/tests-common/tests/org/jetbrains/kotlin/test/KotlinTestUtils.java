...
public class KotlinTestUtils {
  ...
  private static final Pattern DIRECTIVE_PATTERN =
      Pattern.compile("^//\\s*([A-Z_0-9]+)(:[ \\t]*(.*))?$", Pattern.MULTILINE);

  private KotlinTestUtils() {}

  @NotNull
  public static AnalysisResult analyzeFile(
      @NotNull KtFile file, @NotNull KotlinCoreEnvironment environment) {
    return JvmResolveUtil.analyze(file, environment);
  }

  @NotNull
  public static KotlinCoreEnvironment createEnvironmentWithMockJdkAndIdeaAnnotations(
  ...
  public static KotlinCoreEnvironment createEnvironmentWithMockJdkAndIdeaAnnotations(
    ...
    return createEnvironmentWithJdkAndNullabilityAnnotationsFromIdea(
        disposable, configurationKind, TestJdkKind.MOCK_JDK);
  }
  ...
  public static KotlinCoreEnvironment createEnvironmentWithJdkAndNullabilityAnnotationsFromIdea(
    ...
    return KotlinCoreEnvironment.createForTests(
        disposable,
        newConfiguration(configurationKind, jdkKind, KtTestUtil.getAnnotationsJar()),
        EnvironmentConfigFiles.JVM_CONFIG_FILES);
  }

  @NotNull
  public static KotlinCoreEnvironment createEnvironmentWithFullJdkAndIdeaAnnotations(
      Disposable disposable) {
    return createEnvironmentWithJdkAndNullabilityAnnotationsFromIdea(
        disposable, ConfigurationKind.ALL, TestJdkKind.FULL_JDK);
  }
  ...
  public static CompilerConfiguration newConfiguration(
    ...
    return newConfiguration(
        configurationKind, jdkKind, Arrays.asList(extraClasspath), Collections.emptyList());
  }
  ...
  public static CompilerConfiguration newConfiguration(
    ...
    if (configurationKind.getWithRuntime()) {
      ...
      JvmContentRootsKt.addJvmClasspathRoot(
          configuration, ForTestCompileRuntime.scriptRuntimeJarForTests());
      JvmContentRootsKt.addJvmClasspathRoot(
          configuration, ForTestCompileRuntime.kotlinTestJarForTests());
    } else if (configurationKind.getWithMockRuntime()) {
      JvmContentRootsKt.addJvmClasspathRoot(
          configuration, ForTestCompileRuntime.minimalRuntimeJarForTests());
      JvmContentRootsKt.addJvmClasspathRoot(
          configuration, ForTestCompileRuntime.scriptRuntimeJarForTests());
    }
  ...
  public static void resolveAllKotlinFiles(KotlinCoreEnvironment environment) throws IOException {
    List<KotlinSourceRoot> roots =
        ContentRootsKt.getKotlinSourceRoots(environment.getConfiguration());
  ...
  public static void assertEqualsToFile(
      @NotNull String message, @NotNull File expectedFile, @NotNull String actual) {
  ...
  public static Pair<Boolean, String> doesEqualToFile(
      @NotNull File expectedFile,
      @NotNull String actual,
      @NotNull Function1<String, String> sanitizer) {
    try {
      String actualText =
          StringUtilsKt.trimTrailingWhitespacesAndAddNewlineAtEOF(
      ...
      return new Pair<>(
          Objects.equals(sanitizer.invoke(expectedText), sanitizer.invoke(actualText)), expected);
    } catch (IOException e) {
  ...
  public static boolean compileKotlinWithJava(
    ...
    if (!ktFiles.isEmpty()) {
      KotlinCoreEnvironment environment =
          createEnvironmentWithFullJdkAndIdeaAnnotations(disposable);
      CompilerTestLanguageVersionSettingsKt.setupLanguageVersionSettingsForMultifileCompilerTests(
          ktFiles, environment);
  ...
  public static List<String> loadBeforeAfterText(String filePath) {
    ...
    List<String> files =
        TestFiles.createTestFiles(
            "",
            content,
            new TestFiles.TestFileFactoryNoModules<String>() {
              @NotNull
              @Override
              public String create(
                  @NotNull String fileName, @NotNull String text, @NotNull Directives directives) {
  ...
  public static boolean compileJavaFiles(@NotNull Collection<File> files, List<String> options)
      throws IOException {
  ...
  private static boolean compileJavaFiles(
      ...
      throws IOException {
    return JvmCompilationUtils.compileJavaFiles(
        files, options, javaErrorFile, JUnit4Assertions.INSTANCE);
  }

  public static boolean compileJavaFilesExternallyWithJava11(
      @NotNull Collection<File> files, @NotNull List<String> options) {
    return JvmCompilationUtils.compileJavaFilesExternally(
        files, options, KtTestUtil.getJdk11Home());
  }

  public static boolean compileJavaFilesExternally(
      @NotNull Collection<File> files, @NotNull List<String> options, @NotNull File jdkHome) {
  ...
  public static void runTest(
      @NotNull DoTest test, @NotNull TestCase testCase, @TestDataFile String testDataFile) {
    runTestImpl(
        testWithCustomIgnoreDirective(test, TargetBackend.ANY, IGNORE_BACKEND_DIRECTIVE_PREFIXES),
        testCase,
        testDataFile);
  }
  ...
  public static void runTestWithThrowable(
      @NotNull TestCase testCase, @NotNull RunnableWithThrowable test) {
    MuteWithDatabaseKt.runTest(
        testCase,
        () -> {
          try {
            test.run();
  ...
  // So only file paths passed to this parameter will be used in navigation actions, like "Navigate
  // to testdata" and "Related Symbol..."
  public static void runTest(
      DoTest test, TargetBackend targetBackend, @TestDataFile String testDataFile) {
    runTest0(test, targetBackend, testDataFile);
  }

  public static void runTestWithCustomIgnoreDirective(
      DoTest test,
      TargetBackend targetBackend,
      @TestDataFile String testDataFile,
      String ignoreDirective) {
    runTestImpl(
        testWithCustomIgnoreDirective(test, targetBackend, ignoreDirective), null, testDataFile);
  }

  // In this test runner version, NONE of the parameters are annotated by `TestDataFile`.
  // So DevKit will use test name to determine related files in navigation actions, like "Navigate
  // to testdata" and "Related Symbol..."
  //
  // Pro:
  ...
  public static void runTest0(DoTest test, TargetBackend targetBackend, String testDataFilePath) {
    String[] prefixes =
        test.getClass().getSimpleName().startsWith("Fir")
            ? new String[] {IGNORE_BACKEND_DIRECTIVE_PREFIX, IGNORE_BACKEND_K2_DIRECTIVE_PREFIX}
            : IGNORE_BACKEND_DIRECTIVE_PREFIXES;
    runTestImpl(
        testWithCustomIgnoreDirective(test, targetBackend, prefixes), null, testDataFilePath);
  }

  private static void runTestImpl(
      @NotNull DoTest test, @Nullable TestCase testCase, String testDataFilePath) {
    if (testCase != null && !isRunTestOverridden(testCase)) {
      Function0<Unit> wrapWithMuteInDatabase =
          MuteWithDatabaseKt.wrapWithMuteInDatabase(
              testCase,
              () -> {
                try {
  ...
  private static DoTest testWithCustomIgnoreDirective(
      DoTest test, TargetBackend targetBackend, String... ignoreDirectives) {
    return filePath -> {
      ...
      if (isIgnored) {
        ...
        throw new AssertionError(
            String.format(
                "Looks like this test can be unmuted. Remove \"%s\" directive.",
                directivesToRemove.toString()));
      }
    };
  }
  ...
  public static String getTestDataFileName(
      @NotNull Class<?> testCaseClass, @NotNull String testName) {
    try {
  ...
  @NotNull
  public static KtFile loadKtFile(@NotNull Project project, @NotNull File ioFile)
      throws IOException {
  ...
  @NotNull
  public static List<KtFile> loadToKtFiles(
  ...
  @NotNull
  public static ModuleDescriptorImpl createEmptyModule(
      @NotNull String name, @NotNull KotlinBuiltIns builtIns) {
