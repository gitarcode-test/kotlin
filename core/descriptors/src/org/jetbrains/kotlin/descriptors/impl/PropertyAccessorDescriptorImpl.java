...
public abstract class PropertyAccessorDescriptorImpl extends DeclarationDescriptorNonRootImpl
  ...
  protected Collection<PropertyAccessorDescriptor> getOverriddenDescriptors(boolean isGetter) {
    ...
    for (PropertyDescriptor overriddenProperty :
        getCorrespondingProperty().getOverriddenDescriptors()) {
      PropertyAccessorDescriptor accessorDescriptor =
          isGetter ? overriddenProperty.getGetter() : overriddenProperty.getSetter();
  ...
  public void setInitialSignatureDescriptor(
