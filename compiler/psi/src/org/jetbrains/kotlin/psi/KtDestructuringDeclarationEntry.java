...
public class KtDestructuringDeclarationEntry extends KtNamedDeclarationNotStubbed
  ...
  public SearchScope getUseScope() {
    ...
    if (enclosingBlock instanceof KtParameter) {
      enclosingBlock =
          KtPsiUtil.getEnclosingElementForLocalDeclaration((KtParameter) enclosingBlock, false);
    }
