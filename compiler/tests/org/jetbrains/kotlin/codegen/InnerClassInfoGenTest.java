...
public class InnerClassInfoGenTest extends CodegenTestCase {
  ...
  public void testInnerClassInfo() {
    InnerClassAttribute innerB =
        new InnerClassAttribute("A$B", "A", "B", ACC_PUBLIC | ACC_STATIC | ACC_FINAL);
    InnerClassAttribute innerC =
        new InnerClassAttribute("A$B$C", "A$B", "C", ACC_PUBLIC | ACC_FINAL);
    String companionObjectDefaultName = SpecialNames.DEFAULT_NAME_FOR_COMPANION_OBJECT.asString();
    InnerClassAttribute innerACompanionObject =
        new InnerClassAttribute(
            "A$" + companionObjectDefaultName,
            "A",
            companionObjectDefaultName,
  ...
  public void testLocalClass() {
    InnerClassAttribute innerB =
        new InnerClassAttribute("A$foo$B", null, "B", ACC_PUBLIC | ACC_STATIC | ACC_FINAL);
  ...
  public void testAnonymousClass() {
    InnerClassAttribute innerB =
        new InnerClassAttribute("A$B$1", null, null, ACC_PUBLIC | ACC_STATIC | ACC_FINAL);
    InnerClassAttribute innerC =
        new InnerClassAttribute("A$foo$C$1", null, null, ACC_PUBLIC | ACC_STATIC | ACC_FINAL);
  ...
  public void testAnonymousObjectInline() {
    InnerClassAttribute objectInInlineFun =
        new InnerClassAttribute("A$inlineFun$s$1", null, null, ACC_PUBLIC | ACC_STATIC | ACC_FINAL);
    extractAndCompareInnerClasses("A", objectInInlineFun);
  }

  public void testEnumEntry() {
    InnerClassAttribute innerE2 =
        new InnerClassAttribute("E$E2", "E", "E2", ACC_STATIC | ACC_FINAL);
  ...
  public void testInnerAccessFlags() {
    checkAccess(
        "A", "Annotation", ACC_PUBLIC | ACC_STATIC | ACC_INTERFACE | ACC_ABSTRACT | ACC_ANNOTATION);
  ...
  public void testLambdaClassFlags() {
    InnerClassAttribute foo =
        new InnerClassAttribute("A$foo$1", null, null, ACC_STATIC | ACC_FINAL);
    InnerClassAttribute bar =
        new InnerClassAttribute("A$bar$1", null, null, ACC_STATIC | ACC_FINAL);
  ...
  private void checkAccess(@NotNull String outerName, @NotNull String innerName, int accessFlags) {
    ...
    InnerClassAttribute attribute =
        CollectionsKt.single(extractInnerClasses(name), value -> innerName.equals(value.innerName));

    InnerClassAttribute expectedAttribute =
        new InnerClassAttribute(name, outerName, innerName, accessFlags);

    assertEquals(expectedAttribute, attribute);
  }

  private void extractAndCompareInnerClasses(
      @NotNull String className, @NotNull InnerClassAttribute... expectedInnerClasses) {
  ...
  private static class InnerClassAttribute {
    ...
    public String toString() {
      return String.format(
          "InnerClass(name=%s, outerName=%s, innerName=%s, access=%s)",
