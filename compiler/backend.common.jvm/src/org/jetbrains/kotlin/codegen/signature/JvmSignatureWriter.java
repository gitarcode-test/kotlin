...
public class JvmSignatureWriter extends JvmDescriptorTypeWriter<Type> {
  ...
  public void writeParameterType(
      @NotNull JvmMethodParameterKind parameterKind, boolean isSkippedInGenericSignature) {
    currentParameterKind = parameterKind;
  }

  public void writeParameterTypeEnd() {
    //noinspection ConstantConditions
    kotlinParameterTypes.add(
        new JvmMethodParameterSignature(getJvmCurrentType(), currentParameterKind));
  ...
  public JvmMethodGenericSignature makeJvmMethodSignature(@NotNull String name) {
    ...
    return new JvmMethodGenericSignature(
        asmMethod, kotlinParameterTypes, makeJavaGenericSignature());
  }
