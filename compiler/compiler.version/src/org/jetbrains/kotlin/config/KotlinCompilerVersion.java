...
public class KotlinCompilerVersion {
  ...
  // True if the latest stable language version supported by this compiler has not yet been
  // released.
  // Binaries produced by this compiler with that language version (or any future language version)
    ...
    BufferedReader versionReader =
        new BufferedReader(
            new InputStreamReader(
                KotlinCompilerVersion.class.getResourceAsStream(VERSION_FILE_PATH)));
    try {
