...
public abstract class IntrinsicMethod {
  ...
  public Callable toCallable(
    ...
    return toCallable(
        codegen.getState().getTypeMapper().mapToCallableMethod(fd, false), isSuper, resolvedCall);
  }
  ...
  @NotNull
  protected Callable toCallable(
      @NotNull CallableMethod method, boolean isSuper, @NotNull ResolvedCall resolvedCall) {
