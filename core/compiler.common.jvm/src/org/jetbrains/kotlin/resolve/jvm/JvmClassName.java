...
public class JvmClassName {
   ...
   *
   * <p>This method treats all dollar characters ('$') in the internal name as inner class
   * separators. So it _will work incorrectly_ for classes where dollar characters are a part of the
   * identifier.
   *
   * <p>E.g. JvmClassName("org/foo/bar/Baz$quux").getFqNameForClassNameWithoutDollars() ->
   * FqName("org.foo.bar.Baz.quux")
   */
  @NotNull
   ...
   * WARNING: internal name cannot be reliably converted to FQ name.
   *
   * <p>This method treats all dollar characters ('$') in the internal name as a part of the
   * identifier. So it _will work incorrectly_ for inner classes.
   *
   * <p>E.g. JvmClassName("org/foo/bar/Baz$quux").getFqNameForTopLevelClassMaybeWithDollars() ->
   * FqName("org.foo.bar.Baz$quux")
   */
  @NotNull
