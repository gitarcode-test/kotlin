...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl
    implements JavaCallableMemberDescriptor {
  private final boolean isStaticFinal;
  @Nullable private final Pair<UserDataKey<?>, ?> singleUserData;
  ...
  public JavaCallableMemberDescriptor enhance(
    ...
    JavaPropertyDescriptor enhanced =
        new JavaPropertyDescriptor(
  ...
  public boolean isConst() {
    ...
    return isStaticFinal
        && ConstUtil.canBeUsedForConstVal(type)
