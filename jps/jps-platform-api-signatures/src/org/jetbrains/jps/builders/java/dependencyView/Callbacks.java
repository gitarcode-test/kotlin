...
public final class Callbacks {
  ...
  public interface Backend {
    ...
    void associate(
        String classFileName, Collection<String> sources, ClassReader cr, boolean isGenerated);

    void registerImports(
        String className, Collection<String> classImports, Collection<String> staticImports);
  ...
  public static ConstantRef createConstantReference(
      String ownerClass, String fieldName, String descriptor) {
  ...
  public static final class ConstantAffection {
    ...
    public static ConstantAffection compose(
