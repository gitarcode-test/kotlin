...
public class Intrinsics {
    ...
    if (value == null) {
      throw sanitizeStackTrace(
          new IllegalStateException(
              "Method specified as non-null returned null: " + className + "." + methodName));
    }
  }
  ...
  public static void checkFieldIsNotNull(Object value, String className, String fieldName) {
    if (value == null) {
      throw sanitizeStackTrace(
          new IllegalStateException(
              "Field specified as non-null is null: " + className + "." + fieldName));
    }
  }
  ...
  private static void throwParameterIsNullIAE(String paramName) {
    throw sanitizeStackTrace(
        new IllegalArgumentException(createParameterIsNullExceptionMessage(paramName)));
  }

  private static void throwParameterIsNullNPE(String paramName) {
    throw sanitizeStackTrace(
        new NullPointerException(createParameterIsNullExceptionMessage(paramName)));
  }
  ...
  private static String createParameterIsNullExceptionMessage(String paramName) {
    ...
    // Skip all frames of this class such as createParameterIsNullExceptionMessage,
    // throwParameterIsNullNPE, checkNotNullParameter.
    while (stackTraceElements[i].getClassName().equals(thisClassName)) i++;
  ...
  public static boolean areEqual(Double first, Double second) {
    return first == null
        ? second == null
        : second != null && first.doubleValue() == second.doubleValue();
  }
  ...
  public static boolean areEqual(Float first, Float second) {
    return first == null
        ? second == null
        : second != null && first.floatValue() == second.floatValue();
  }
  ...
  public static void throwUndefinedForReified() {
    throwUndefinedForReified(
        "This function has a reified type parameter and thus can only be inlined at compilation"
            + " time, not called directly.");
  }
  ...
  public static void reifiedOperationMarker(
      int id, String typeParameterIdentifier, String message) {
  ...
  // Stub class which is used as an owner of callable references for built-ins declared in package
  // "kotlin".
  @SinceKotlin(version = "1.4")
