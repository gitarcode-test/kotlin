...
/**
 * An input buffer that combines fast character-based access with (slower) support for retrieving
 * the text of the current line. It also supports building strings directly out of the internal
 * buffer to support fast scanning with minimal object creation.
 *
 * <p>Note that it is customized in several ways to support the TokenStream class, and should not be
 * considered general.
 *
 * <p>Credits to Kipp Hickman and John Bandhauer.
 */
