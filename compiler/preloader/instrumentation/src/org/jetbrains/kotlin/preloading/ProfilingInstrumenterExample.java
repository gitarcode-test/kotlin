...
public class ProfilingInstrumenterExample extends InterceptionInstrumenterAdaptor {
  ...
  @MethodInterceptor(
      className = "com/intellij/openapi/util/text/StringUtil",
  ...
  public static class MethodCollector {
    ...
    public void enter(
        @ClassName String className, @MethodName String name, @MethodDesc String desc) {
  ...
  public abstract static class FirstArgumentCollector {
