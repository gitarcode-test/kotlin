...
public abstract class VariableDescriptorWithInitializerImpl extends VariableDescriptorImpl {
  ...
  public void setCompileTimeInitializerFactory(
      @NotNull Function0<NullableLazyValue<ConstantValue<?>>> compileTimeInitializerFactory) {
    assert !isVar()
        : "Constant value for variable initializer should be recorded only for final variables: "
            + getName();
  ...
  public void setCompileTimeInitializer(
    ...
    this.compileTimeInitializer =
        compileTimeInitializer != null
            ...
            : compileTimeInitializerFactory.invoke();
  }
