...
public class KtParameter extends KtNamedDeclarationStub<KotlinParameterStub>
    implements KtCallableDeclaration, KtValVarKeywordOwner {
  ...
  public KtExpression getDefaultValue() {
    ...
    return equalsToken != null
        ? PsiTreeUtil.getNextSiblingOfType(equalsToken, KtExpression.class)
        : null;
  }
  ...
  public static final TokenSet VAL_VAR_TOKEN_SET =
      TokenSet.create(KtTokens.VAL_KEYWORD, KtTokens.VAR_KEYWORD);
  ...
  /**
   * For example, lambdaConsumer { lambdaParameter -> ... }
   *
  ...
  /**
   * For example, fun foo(lambdaArgument: (functionTypeParameter: T, ...) -> R) { ... }
   *
