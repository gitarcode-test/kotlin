...
public class MavenPluginLogMessageCollector implements MessageCollector {
  ...
  private final ArrayList<Pair<CompilerMessageSourceLocation, String>> collectedErrors =
      new ArrayList<>();
                ...
                pair -> {
                  ...
                  if (location == null) {
                    return new CompilerMessage(
                        null, CompilerMessage.Kind.ERROR, 0, 0, 0, 0, message);
                  }
