...
public abstract class StackValue {
  ...
  private static final StackValue UNIT =
      operation(
          ...
          v -> {
            v.visitFieldInsn(
                GETSTATIC,
                UNIT_TYPE.getInternalName(),
                JvmAbi.INSTANCE_FIELD,
                UNIT_TYPE.getDescriptor());
            return null;
          });

  @NotNull public final Type type;
  @Nullable public final KotlinType kotlinType;
  ...
  protected StackValue(
      @NotNull Type type, @Nullable KotlinType kotlinType, boolean canHaveSideEffects) {
    this.type = type;
  ...
  /**
   * This method is called to put the value on the top of the JVM stack if <code>depth</code> other
   * values have been put on the JVM stack after this value was generated.
   *
  ...
  public void store(
      @NotNull StackValue value, @NotNull InstructionAdapter v, boolean skipReceiver) {
    if (!skipReceiver) {
      putReceiver(v, false);
    }
  ...
  @NotNull
  public static StackValue local(
      int index, @NotNull Type type, @NotNull VariableDescriptor descriptor) {
  ...
  public static StackValue local(
    ...
    if (descriptor.isLateInit()) {
      assert delegateKotlinType == null
          : "Delegated property can't be lateinit: "
              + descriptor
              + ", delegate type: "
              + delegateKotlinType;
      ...
      return new Local(
          index, type, delegateKotlinType != null ? delegateKotlinType : descriptor.getType());
    }
  }
  ...
  @NotNull
  public static StackValue shared(
      int index, @NotNull Type type, @NotNull VariableDescriptor descriptor) {
  ...
  @NotNull
  public static StackValue constant(
      @Nullable Object value, @NotNull Type type, @Nullable KotlinType kotlinType) {
    if (type == Type.BOOLEAN_TYPE) {
      assert value instanceof Boolean
          : "Value for boolean constant should have boolean type: " + value;
  ...
  private static StackValue createDefaultPrimitiveValue(@NotNull Type type) {
    assert Type.BOOLEAN <= type.getSort() && type.getSort() <= Type.DOUBLE
        : "'createDefaultPrimitiveValue' method should be called only for primitive types, but "
            + type;
    Object value = 0;
  ...
  @NotNull
  public static StackValue cmp(
      @NotNull IElementType opToken, @NotNull Type type, StackValue left, StackValue right) {
  ...
  public static StackValue arrayElement(
      @NotNull Type type, @Nullable KotlinType kotlinType, StackValue array, StackValue index) {
  ...
  public static StackValue collectionElement(
    ...
    return new CollectionElement(
        collectionElementReceiver, type, kotlinType, getter, setter, codegen);
  }

  public static UnderlyingValueOfInlineClass underlyingValueOfInlineClass(
      @NotNull Type type, @Nullable KotlinType kotlinType, @NotNull StackValue receiver) {
  ...
  public static StackValue changeReceiverForFieldAndSharedVar(
      @NotNull StackValueWithSimpleReceiver stackValue, @Nullable StackValue newReceiver) {
    // TODO static check
  ...
  @NotNull
  public static StackValue expression(
      Type type, KtExpression expression, ExpressionCodegen generator) {
  ...
  private static void box(Type type, Type toType, InstructionAdapter v) {
    ...
    v.invokestatic(
        boxedType.getInternalName(), "valueOf", Type.getMethodDescriptor(boxedType, type), false);
  ...
  private static void unbox(Type methodOwner, Type type, InstructionAdapter v) {
    assert isPrimitive(type)
        : "Unboxing should be performed to primitive type, but " + type.getClassName();
    v.invokevirtual(
        methodOwner.getInternalName(),
  ...
  public static void boxInlineClass(
      @NotNull KotlinTypeMarker kotlinType,
      @NotNull InstructionAdapter v,
    ...
    boolean isNullable =
        typeMapper.getTypeSystem().isNullableType(kotlinType) && !isPrimitive(unboxed);
    boxInlineClass(unboxed, boxed, isNullable, v);
  }

  public static void boxInlineClass(
      @NotNull Type unboxed,
      @NotNull Type boxed,
      boolean isNullable,
      @NotNull InstructionAdapter v) {
    if (isNullable) {
  ...
  private static void invokeBoxMethod(
      @NotNull InstructionAdapter v, @NotNull Type boxedType, @NotNull Type underlyingType) {
    v.invokestatic(
  ...
  public static void unboxInlineClass(
    ...
    Type unboxed =
        KotlinTypeMapper.mapUnderlyingTypeOfInlineClassType(targetInlineClassType, typeMapper);
    boolean isNullable =
        typeMapper.getTypeSystem().isNullableType(targetInlineClassType) && !isPrimitive(unboxed);
  ...
  private static void invokeUnboxMethod(
      @NotNull InstructionAdapter v, @NotNull Type owner, @NotNull Type resultType) {
    v.invokevirtual(
  ...
  private static void boxOrUnboxWithNullCheck(
      @NotNull InstructionAdapter v, @NotNull Consumer<InstructionAdapter> body) {
    Label lNull = new Label();
    Label lDone = new Label();
    // NB The following piece of code looks sub-optimal (we have a 'null' value on stack and could
    // just keep it there),
    // but it is required, because bytecode verifier doesn't take into account null checks,
    // and sees null-checked value on the top of the stack as a value of the source type (e.g.,
    // Ljava/lang/String;),
  ...
  protected void coerceTo(
      @NotNull Type toType, @Nullable KotlinType toKotlinType, @NotNull InstructionAdapter v) {
  ...
  public static void coerce(
      ...
      @NotNull InstructionAdapter v) {
    if (coerceInlineClasses(
        fromType, fromKotlinType, toType, toKotlinType, v, StaticTypeMapperForOldBackend.INSTANCE))
      return;
  ...
  public static boolean requiresInlineClassBoxingOrUnboxing(
    ...
    boolean isFromTypeUnboxed =
        isFromTypeInlineClass && isUnboxedInlineClass(fromKotlinType, fromType);
  ...
  public static boolean isUnboxedInlineClass(
      @NotNull KotlinType kotlinType, @NotNull Type actualType) {
    return KotlinTypeMapper.mapUnderlyingTypeOfInlineClassType(
            kotlinType, StaticTypeMapperForOldBackend.INSTANCE)
        .equals(actualType);
  }

  public static void coerce(
      @NotNull Type fromType, @NotNull Type toType, @NotNull InstructionAdapter v) {
  ...
  public static Field receiverWithRefWrapper(
      ...
      @Nullable DeclarationDescriptor descriptor) {
    return field(
        sharedTypeForType(localType), null, classType, fieldName, false, receiver, descriptor);
  }
  ...
  @NotNull
  public static FieldForSharedVar fieldForSharedVar(
      @NotNull FieldForSharedVar field, @NotNull StackValue newReceiver) {
    ...
    return new FieldForSharedVar(
        ...
        field.owner,
        field.name,
        newSharedVarReceiver,
        field.isLateinit,
        field.variableName);
  }

  public static StackValue coercion(
      @NotNull StackValue value, @NotNull Type castType, @Nullable KotlinType castKotlinType) {
  ...
  public static StackValue coercionValueForArgumentOfInlineClassConstructor(
    ...
    boolean kotlinTypesAreEqual =
        value.kotlinType == null && castKotlinType == null
            || value.kotlinType != null
                && castKotlinType != null
                && castKotlinType.equals(value.kotlinType);
  ...
  public static StackValue thisOrOuter(
    ...
    // Do not coerce for other cases due to the 'protected' access issues (JVMS 7, 4.9.2 Structural
    // Constraints).
    boolean coerceType =
        descriptor.getKind() == ClassKind.INTERFACE
            || InlineClassesUtilsKt.isInlineClass(descriptor)
  ...
  public static StackValue preIncrementForLocalVar(
      int index, int increment, @Nullable KotlinType kotlinType) {
  ...
  public static StackValue receiver(
    ...
    if (descriptor instanceof SyntheticFieldDescriptor) {
      callDispatchReceiver =
          ((SyntheticFieldDescriptor) descriptor).getDispatchReceiverForBackend();
    }
    ...
    if (callDispatchReceiver != null
        ...
        || isLocalFunCall(callableMethod)
        || isImportedObjectMember) {
      ...
      if (descriptor instanceof SyntheticFieldDescriptor) {
        dispatchReceiverParameter =
            ((SyntheticFieldDescriptor) descriptor).getDispatchReceiverParameterForBackend();
      }

      boolean hasExtensionReceiver = callExtensionReceiver != null;
      StackValue dispatchReceiver =
          platformStaticCallIfPresent(
              genReceiver(
                  hasExtensionReceiver ? none() : receiver,
                  codegen,
                  descriptor,
                  callableMethod,
                  callDispatchReceiver,
      ...
      StackValue extensionReceiver =
          genReceiver(receiver, codegen, descriptor, callableMethod, callExtensionReceiver, true);
      ...
      if (receiverValue != null) {
        ...
        if (descriptor instanceof SimpleFunctionDescriptor) {
          SimpleFunctionDescriptor initial =
              CoroutineCodegenUtilKt.unwrapInitialDescriptorForSuspendFunction(
        ...
        assert value != null
            : "Local fun should be found in locals or in captured params: " + descriptor;
        return value;
      } else if (!isExtension && DescriptorUtils.isObject(containingDeclaration)) {
        // Object member could be imported by name, in which case it has no explicit dispatch
        // receiver
  ...
  private static StackValue putLocalSuspendFunctionOnStack(
      @NotNull ExpressionCodegen codegen, SimpleFunctionDescriptor callee) {
    ...
    // 3) recursive call: we are in the middle of defining it, but, thankfully, we can simply call
    // `this.invoke` to
    ...
    if (codegen.context.hasThisDescriptor()) {
      ...
      if (thisDescriptor instanceof SyntheticClassDescriptorForLambda
        ...
        Boolean isRecursive =
            bindingContext.get(RECURSIVE_SUSPEND_CALLABLE_REFERENCE, thisDescriptor);
      ...
      if (classDescriptor == thisDescriptor) {
        // Recursive suspend local function, just call invoke on this, it will create new coroutine
        // automatically
  ...
  private static StackValue platformStaticCallIfPresent(
      @NotNull StackValue resultReceiver, @NotNull CallableDescriptor descriptor) {
  ...
  @NotNull
  public static Field enumEntry(
      @NotNull ClassDescriptor descriptor, @NotNull KotlinTypeMapper typeMapper) {
    DeclarationDescriptor enumClass = descriptor.getContainingDeclaration();
    assert DescriptorUtils.isEnumClass(enumClass)
        : "Enum entry should be declared in enum class: " + descriptor;
  ...
  public static StackValue operation(
      Type type, KotlinType kotlinType, Function1<InstructionAdapter, Unit> lambda) {
    return new OperationStackValue(type, kotlinType, lambda);
  }

  public static StackValue functionCall(
      Type type, KotlinType kotlinType, Function1<InstructionAdapter, Unit> lambda) {
    ...
    private LateinitLocal(int index, Type type, KotlinType kotlinType, Name name) {
      ...
      if (name == null) {
        throw new IllegalArgumentException(
            "Lateinit local variable should have name: #" + index + " " + type.getDescriptor());
      }
  ...
  public static class Delegate extends StackValue {
    ...
    @NotNull private final VariableDescriptorWithAccessors variableDescriptor;
    ...
    private ResolvedCall<FunctionDescriptor> getResolvedCall(boolean isGetter) {
      ...
      VariableAccessorDescriptor accessor =
          isGetter ? variableDescriptor.getGetter() : variableDescriptor.getSetter();
      assert accessor != null
          : "Accessor descriptor for delegated local property should be present "
              + variableDescriptor;
      ResolvedCall<FunctionDescriptor> resolvedCall =
          bindingContext.get(BindingContext.DELEGATED_PROPERTY_RESOLVED_CALL, accessor);
      assert resolvedCall != null
          : "Resolve call should be recorded for delegate call " + variableDescriptor;
      return resolvedCall;
    }
    ...
    public void putSelector(
      ...
      codegen.tempVariables.put(
          arguments.get(0).asElement(), StackValue.constant(null, OBJECT_TYPE));
      ...
      if (depth == 0) {
        ...
        if (size == 1) {
          ...
          throw new UnsupportedOperationException(
              "don't know how to move type " + type + " to top of stack");
        }
  ...
  public static class Constant extends StackValue {
    ...
    public Constant(@Nullable Object value, Type type, KotlinType kotlinType) {
      super(type, kotlinType, false);
      assert !Type.BOOLEAN_TYPE.equals(type)
          : "Boolean constants should be created via 'StackValue.constant'";
      this.value = value;
    }
  ...
  public static class CollectionElementReceiver extends StackValue {
    ...
    public void putSelector(
      ...
      defaultArgs =
          generator.generate(valueArguments, valueArguments, call.getResultingDescriptor());
    }

    private ArgumentGenerator createArgumentGenerator() {
      assert callGenerator == null
          : "'putSelector' and 'createArgumentGenerator' methods should be called once for"
      ...
      callGenerator =
          !isComplexOperationWithDup
              ? codegen.getOrCreateCallGenerator(resolvedCall)
    ...
    public void dupReceiver(@NotNull InstructionAdapter v) {
      ...
      List<ValueParameterDescriptor> valueParameters =
          resolvedGetCall.getResultingDescriptor().getValueParameters();
      ...
      if (resolvedSetCall.getDispatchReceiver() != null) {
        if (resolvedSetCall.getExtensionReceiver() != null) {
          codegen
              .generateReceiverValue(resolvedSetCall.getDispatchReceiver(), false)
              .put(OBJECT_TYPE, null, v);
        }
  ...
  public static class CollectionElement extends StackValueWithSimpleReceiver {
    ...
    public CollectionElement(
      ...
      this.resolvedSetCall = resolvedSetCall;
      this.setter =
          resolvedSetCall == null
              ? null
              : codegen.resolveToCallable(
                  codegen.accessibleFunctionDescriptor(resolvedSetCall), false, resolvedSetCall);
      this.getter =
          resolvedGetCall == null
              ? null
              : codegen.resolveToCallable(
                  codegen.accessibleFunctionDescriptor(resolvedGetCall), false, resolvedGetCall);
      this.codegen = codegen;
    }
    ...
    public void putSelector(
      ...
      callGenerator.genCall(
          getter, resolvedGetCall, genDefaultMaskIfPresent(callGenerator), codegen);
      coerceTo(type, kotlinType, v);
    }
    ...
    public static boolean isStandardStack(
        @NotNull KotlinTypeMapper typeMapper, @Nullable ResolvedCall<?> call, int valueParamsSize) {
      if (call == null) {
        return true;
      }

      List<ValueParameterDescriptor> valueParameters =
          call.getResultingDescriptor().getValueParameters();
      ...
      if (call.getDispatchReceiver() != null) {
        ...
        if (typeMapper
                .mapType(call.getResultingDescriptor().getExtensionReceiverParameter().getType())
                .getSize()
            != 1) {
          return false;
        }
    ...
    public void storeSelector(
      ...
      KotlinType lastParameterKotlinType =
          CollectionsKt.last(
                  resolvedSetCall.getResultingDescriptor().getOriginal().getValueParameters())
              .getType();
      ...
      boolean properSetterCalls =
          codegen
              .getState()
              .getLanguageVersionSettings()
              .supportsFeature(LanguageFeature.ProperArrayConventionSetterWithDefaultCalls);
      if (collectionElementReceiver.isGetter) {
        // Convention setter/getter could have default parameters at the end of parameter list (in
        // case of setter before last parameter)
        // We should remove default parameters of getter from stack if they don't match setter ones
        // and regenerate mask for setter
        // Note that it works only for non-inline cases

        // TODO: try to don't generate defaults at all in CollectionElementReceiver

        List<ResolvedValueArgument> getterArguments =
            new ArrayList<>(collectionElementReceiver.valueArguments);
        List<ResolvedValueArgument> getterDefaults =
            CollectionsKt.takeLastWhile(
                getterArguments, argument -> argument instanceof DefaultValueArgument);

        List<ResolvedValueArgument> setterArguments = resolvedSetCall.getValueArgumentsByIndex();
        List<ResolvedValueArgument> setterDefaults =
            CollectionsKt.takeLastWhile(
                CollectionsKt.dropLast(setterArguments, 1),
                argument -> argument instanceof DefaultValueArgument);

        if (!getterDefaults.isEmpty() || !setterDefaults.isEmpty()) {
          Local rhsValue =
              StackValue.local(codegen.myFrameMap.enterTemp(lastParameterType), lastParameterType);
          ...
          if (properSetterCalls) {
            DefaultCallArgs defaultArgs =
                new DefaultCallArgs(
                    CodegenUtilKt.unwrapFrontendVersion(resolvedSetCall.getResultingDescriptor())
                        .getValueParameters()
                        .size());
            if (!setterDefaults.isEmpty()) {
              ArgumentGenerator setterArgumentGenerator =
                  new CallBasedArgumentGenerator(
                      codegen,
                      callGenerator,
                      resolvedSetCall.getResultingDescriptor().getValueParameters(),
                      setter.getValueParameterTypes());

              int defaultIndex =
                  CollectionsKt.getLastIndex(setterArguments)
                      - 1 /*rhs value*/
                      - setterDefaults.size();
              for (ResolvedValueArgument aDefault : setterDefaults) {
                defaultArgs.mark(++defaultIndex);
                setterArgumentGenerator.generateDefault(
                    defaultIndex, (DefaultValueArgument) aDefault);
              }
              callDefault = true;
            }
            rhsValue.put(v);
  ...
  public static class Field extends StackValueWithSimpleReceiver {
    ...
    public void putSelector(
        @NotNull Type type, @Nullable KotlinType kotlinType, @NotNull InstructionAdapter v) {
      v.visitFieldInsn(
          isStaticPut ? GETSTATIC : GETFIELD,
          owner.getInternalName(),
          name,
    ...
    public void storeSelector(
      ...
      coerceFrom(topOfStackType, topOfStackKotlinType, v);
      v.visitFieldInsn(
          isStaticStore ? PUTSTATIC : PUTFIELD,
          owner.getInternalName(),
          name,
          this.type.getDescriptor());
    }
  ...
  public static class Property extends StackValueWithSimpleReceiver {
    ...
    public Property(
      ...
      super(
          type,
          descriptor.getType(),
          isStatic(isStaticBackingField, getter),
          isStatic(isStaticBackingField, setter),
          receiver,
          true);
    ...
    private static class DelegatePropertyConstructorMarker {
      ...
      public static final DelegatePropertyConstructorMarker MARKER =
          new DelegatePropertyConstructorMarker();
    }

    /**
     * Given a delegating property, create a "property" corresponding to the underlying delegate
     * itself. This will take care of backing fields, accessors, and other such stuff. Note that we
     * just replace <code>kotlinType</code> with the <code>delegateKotlinType</code> (so that type
     * coercion will work properly), and <code>delegateKotlinType</code> with <code>null</code> (so
     * that the resulting property has no underlying delegate of its own).
     *
    ...
    private Property(
        @NotNull Property delegating, @NotNull DelegatePropertyConstructorMarker marker) {
      super(
          delegating.type,
          delegating.delegateKotlinType,
          delegating.isStaticPut,
          delegating.isStaticStore,
          delegating.receiver,
          true);
    ...
    public void putSelector(
      ...
      if (getter == null) {
        assert fieldName != null
            : "Property should have either a getter or a field name: " + descriptor;
        assert backingFieldOwner != null
            : "Property should have either a getter or a backingFieldOwner: " + descriptor;
        if (inlineConstantIfNeeded(type, kotlinType, v)) return;

        v.visitFieldInsn(
            isStaticPut ? GETSTATIC : GETFIELD,
            backingFieldOwner.getInternalName(),
            fieldName,
            this.type.getDescriptor());
        if (!skipLateinitAssertion && descriptor.isLateInit()) {
          ...
          boolean isCompanionAccessor =
              contextDescriptor instanceof AccessorForPropertyBackingField
                  && ((AccessorForPropertyBackingField) contextDescriptor).getAccessorKind()
        ...
        if (resolvedCall != null && getterDescriptor.isInline()) {
          CallGenerator callGenerator =
              codegen.getOrCreateCallGenerator(
                  resolvedCall,
                  ((PropertyDescriptor) resolvedCall.getResultingDescriptor()).getGetter());
          callGenerator.processHiddenParameters();
          callGenerator.putHiddenParamsIntoLocals();
        ...
        // For non-private lateinit properties in companion object, the assertion is generated in
        // the public getFoo method
        // in the companion and _not_ in the synthetic accessor access$getFoo$cp in the outer class.
        // The reason is that this way,
        // the synthetic accessor can be reused for isInitialized checks, which require there to be
        // no assertion.
        // For lateinit properties that are accessed via the backing field directly (or via the
        // synthetic accessor, if the access
        // is from a different context), the assertion will be generated on each access, see
        // KT-28331.
        if (descriptor instanceof AccessorForPropertyBackingField) {
          PropertyDescriptor property =
              ((AccessorForPropertyBackingField) descriptor).getCalleeDescriptor();
          if (!skipLateinitAssertion
              && property.isLateInit()
              && DescriptorsJvmAbiUtil.isPropertyWithBackingFieldInOuterClass(property)
              && !JvmCodegenUtil.couldUseDirectAccessToProperty(
                  property, true, false, codegen.context, false)) {
    ...
    public void store(
      ...
      if (resolvedCall != null && setterDescriptor != null && setterDescriptor.isInline()) {
        ...
        CallGenerator callGenerator =
            codegen.getOrCreateCallGenerator(
                resolvedCall,
                ((PropertyDescriptor) resolvedCall.getResultingDescriptor()).getSetter());
        if (!skipReceiver) {
          putReceiver(v, false);
        }
        callGenerator.processHiddenParameters();
    ...
    public void storeSelector(
      ...
      if (setter == null) {
        coerceFrom(topOfStackType, topOfStackKotlinType, v);
        assert fieldName != null
            : "Property should have either a setter or a field name: " + descriptor;
        assert backingFieldOwner != null
            : "Property should have either a setter or a backingFieldOwner: " + descriptor;
        v.visitFieldInsn(
            isStaticStore ? PUTSTATIC : PUTFIELD,
            backingFieldOwner.getInternalName(),
            fieldName,
        ...
        KotlinType setterLastParameterType =
            setterDescriptor != null
                ? CollectionsKt.last(setterDescriptor.getValueParameters()).getReturnType()
                : null;

        coerce(
            topOfStackType,
            topOfStackKotlinType,
            ArraysKt.last(this.setter.getParameterTypes()),
            setterLastParameterType,
            v);
    ...
    private static boolean isStatic(
        boolean isStaticBackingField, @Nullable CallableMethod callable) {
      ...
      if (callable != null && callable.isStaticCall()) {
        ...
        for (JvmMethodParameterSignature parameter : parameters) {
          ...
          if (kind == JvmMethodParameterKind.CONTEXT_RECEIVER
              || kind == JvmMethodParameterKind.RECEIVER
              || kind == JvmMethodParameterKind.THIS) {
            return false;
          }
        }
        return true;
  ...
  private static void genNonNullAssertForLateinit(
      @NotNull InstructionAdapter v, @NotNull String name) {
    v.dup();
    Label ok = new Label();
    v.ifnonnull(ok);
    v.visitLdcInsn(name);
  ...
  public static class Shared extends StackValueWithSimpleReceiver {
    ...
    public Shared(int index, Type type, KotlinType kotlinType, boolean isLateinit, Name name) {
      ...
      if (isLateinit && name == null) {
        throw new IllegalArgumentException(
            "Lateinit shared local variable should have name: #"
                + index
                + " "
                + type.getDescriptor());
      }
  ...
  public static class FieldForSharedVar extends StackValueWithSimpleReceiver {
    ...
    public FieldForSharedVar(
      ...
      if (isLateinit && variableName == null) {
        throw new IllegalArgumentException(
            "variableName should be non-null for captured lateinit variable " + name);
      }
    ...
    public void storeSelector(
      ...
      v.visitFieldInsn(
          PUTFIELD,
          sharedTypeForType(type).getInternalName(),
          "element",
          refType(type).getDescriptor());
    }
  ...
  private static class ThisOuter extends StackValue {
    ...
    public void putSelector(
      ...
      stackValue.put(
          coerceType ? type : stackValue.type, coerceType ? kotlinType : stackValue.kotlinType, v);
    }
  }
  ...
  private static class PrefixIncrement extends StackValue {
    ...
    public void putSelector(
      ...
      value.store(
          codegen.invokeFunction(resolvedCall, StackValue.onStack(this.type, this.kotlinType)),
          v,
          true);
  ...
  private static StackValue complexReceiver(StackValue stackValue, boolean... isReadOperations) {
    ...
    if (stackValue instanceof StackValueWithSimpleReceiver) {
      return new DelegatedForComplexReceiver(
          stackValue.type,
          (StackValueWithSimpleReceiver) stackValue,
  ...
  private static void throwUnsupportedComplexOperation(@NotNull CallableDescriptor descriptor) {
    throw new RuntimeException(
        "Augmented assignment and increment are not supported for local delegated properties and"
            + " inline properties: "
            + descriptor);
  }
}
