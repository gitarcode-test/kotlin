...
public class TypeUtils {
  ...
  @NotNull public static final SimpleType NO_EXPECTED_TYPE = new SpecialType("NO_EXPECTED_TYPE");
  ...
  public static boolean isNullableType(@NotNull KotlinType type) {
    ...
    if (FlexibleTypesKt.isFlexible(type)
        && isNullableType(FlexibleTypesKt.asFlexibleType(type).getUpperBound())) {
      return true;
    }
    ...
    if (type instanceof AbstractStubType) {
      NewTypeVariableConstructor typeVariableConstructor =
          (NewTypeVariableConstructor) ((AbstractStubType) type).getOriginalTypeVariable();
  ...
  public static boolean acceptsNullable(@NotNull KotlinType type) {
    ...
    if (FlexibleTypesKt.isFlexible(type)
        && acceptsNullable(FlexibleTypesKt.asFlexibleType(type).getUpperBound())) {
      return true;
    }
    return false;
  }
  ...
  public static boolean contains(
      @Nullable KotlinType type, @NotNull Function1<UnwrappedType, Boolean> isSpecialType) {
  ...
  private static boolean contains(
    ...
    FlexibleType flexibleType =
        unwrappedType instanceof FlexibleType ? (FlexibleType) unwrappedType : null;
    ...
    if (unwrappedType instanceof DefinitelyNotNullType
        && contains(
            ((DefinitelyNotNullType) unwrappedType).getOriginal(), isSpecialType, visited)) {
      return true;
    }
    ...
    if (typeConstructor instanceof IntersectionTypeConstructor) {
      IntersectionTypeConstructor intersectionTypeConstructor =
          (IntersectionTypeConstructor) typeConstructor;
  ...
  @NotNull
  public static TypeProjection makeStarProjection(
      @NotNull TypeParameterDescriptor parameterDescriptor, ErasureTypeAttributes attr) {
  ...
  @Nullable
  private static KotlinType findByFqName(
      @NotNull Collection<KotlinType> supertypes, FqName fqName) {
  ...
  public static boolean isTypeParameter(@NotNull KotlinType type) {
    return getTypeParameterDescriptorOrNull(type) != null
        || type.getConstructor() instanceof NewTypeVariableConstructor;
  }
